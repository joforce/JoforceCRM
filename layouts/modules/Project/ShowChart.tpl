...
{if !empty($PROJECT_TASKS['tasks'])}
    <div class="pull-right" style="margin-right: 5px;">
        ...
        <span style="margin: 2px;">
            <a href="{$SITEURL}index.php?module=Project&view=ExportChart&record={$PARENT_ID}" target="_blank" class="btn reportActions btn-default">
    ...
    <br />
    <br />
    <input id="projecttasks"  type="hidden" value="{Head_Util_Helper::toSafeHTML(Zend_Json::encode($PROJECT_TASKS))}">
    <input id="originalprojecttasks" type="hidden" value="{Head_Util_Helper::toSafeHTML(Zend_Json::encode($PROJECT_TASKS))}">
