...
{strip}
	...
	{$RECORD_STRUCTURE=$RECORD_STRUCTURE|array_diff_key:(['LBL_CALENDAR_SETTINGS']|array_flip)}
					...
					<tbody {if $IS_HIDDEN} class="hide" {/if}>
						...
						<tr>
							{foreach item=FIELD_MODEL key=FIELD_NAME from=$FIELD_MODEL_LIST}
								{if $FIELD_MODEL->getName() eq 'theme' or $FIELD_MODEL->getName() eq 'rowheight'}{continue}{/if}
