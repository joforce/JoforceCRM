...
function getModuleID(){
 var moduleName = $("#layoutEditorModules").val();
  location.href="index.php?module=DuplicateCheck&parent=Settings&view=List&sourceModule="+moduleName;
...
{strip}
	...
	<form method="POST" action="index.php?module=DuplicateCheck&parent=Settings&view=UpdateFields" id="vtduplicateform">
...
<br>
         <hr class='hr-dotted' style='width:100%;'> 
            <div class="tab-content layoutContent padding20 themeTableColor overflowVisible">
                                    ...
                                    <div class="tab-pane active" id="detailViewLayout"> <h4 style="position: relative; top: 25px;">Configure Field Rule</h4>  <div class="col-sm-7 marginLeftZero" style="float:right !important;">  <input type="hidden" name="modulename" id="modulename" value="{$SELECTED_MODULE_NAME}" /><div><button class="btn btn-default" onclick="window.location.reload();" style="float:right" value="Save">Cancel</button></div><div><button class="btn btn-success" name="savebutton" style="float:right" type="submit" value="Save">Save</button>
