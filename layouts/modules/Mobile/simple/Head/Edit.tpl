...
<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/Head/js/Edit.js"></script>
{literal}

    <form name="editForm" id="field-edit-form" ng-submit="saveThisRecord()" ng-controller="HeadEditController">
