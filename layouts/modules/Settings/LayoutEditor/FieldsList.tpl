...
{strip}
							...
							<div class="layoutBlockHeader row">
								<div class="blockLabel col-sm-3 padding10 marginLeftZero" style="word-break: break-all;">
									{if $IS_BLOCK_SORTABLE}
										<img class="cursorPointerMove" src="{$SITEURL}{vimage_path('drag.png')}" />&nbsp;&nbsp;
									{/if}
								...
								<div class="col-sm-9 padding10 marginLeftZero">
									<div class="blockActions" style="float:right !important;">
										...
										{if $BLOCK_MODEL->isAddCustomFieldEnabled()}
											<button class="btn btn-secondary addButton btn-sm addCustomField" type="button">
														...
														<div class="row">
															...
															<span class="col-sm-1">&nbsp;
																{if $IS_FIELDS_SORTABLE}
																	<img src="{$SITEURL}{vimage_path('drag.png')}" class="cursorPointerMove" border="0" title="{vtranslate('LBL_DRAG',$QUALIFIED_MODULE)}"/>
																{/if}
															</span>
													...
													<div class="row " style="padding: 10px 0px;">
														...
														<div class="fieldProperties col-sm-10" data-field-id="{$FIELD_MODEL->get('id')}">
															...
															<span class="massEdit switch {if (!$IS_MASS_EDIT_ENABLED)} disabled {/if} 
																...
																<img src="{$SITEURL}{vimage_path('MassEdit.png')}" data-name="masseditable" 
																...
																{if $DEFAULT_VALUE}
																	{if is_array($DEFAULT_VALUE)}
																		{foreach key=DEFAULT_FIELD_NAME item=DEFAULT_FIELD_VALUE from=$DEFAULT_VALUE}
																			<div class="row">
																				<span><img src="{$SITEURL}{vimage_path('DefaultValue.png')}"
																	...
																	{else}
																		<div class="row">
																			<span>
																				<img src="{$SITEURL}{vimage_path('DefaultValue.png')}"
																					 {if $FIELD_MODEL->isDefaultValueOptionDisabled()} readonly="readonly" {/if}
								...
								{if count($FIELDS_LIST)%2 neq 0 }
									{if $BLOCK_MODEL->isAddCustomFieldEnabled()}
										<li class="row dummyRow">
											...
											<span class="col-sm-4" style="margin-top: 7%;margin-left: -15%;">
												<button class="btn btn-secondary btn-sm addButton" style="padding: 2px 15px;"><i class="fa fa-plus"></i>&nbsp{vtranslate('LBL_ADD',$QUALIFIED_MODULE)}</button>
											</span>
										</li>
									{/if}
								{/if}
	...
	<input type="hidden" class="inActiveFieldsArray" value='{Head_Functions::jsonEncode($IN_ACTIVE_FIELDS)}' />
	<input type="hidden" id="headerFieldsCount" value="{$HEADER_FIELDS_COUNT}">
	<input type="hidden" id="nameFields" value='{Head_Functions::jsonEncode($SELECTED_MODULE_MODEL->getNameFields())}'>
	<input type="hidden" id="headerFieldsMeta" value='{Head_Functions::jsonEncode($HEADER_FIELDS_META)}'>
	...
	<div id="" class="newCustomBlockCopy hide marginBottom10px border1px blockSortable" data-block-id="" data-sequence="">
		<div class="layoutBlockHeader">
			<div class="col-sm-3 blockLabel padding10 marginLeftZero" style="word-break: break-all;">
				<img class="alignMiddle" src="{$SITEURL}{vimage_path('drag.png')}" />&nbsp;&nbsp;
			</div>
			<div class="col-sm-9 padding10 marginLeftZero">
				<div class="blockActions" style="float: right !important;">
					<span>
			...
			<div class="col-sm-4">
				<div class="marginLeftZero" data-field-id="" data-sequence="">
					<div class="row">
						<span class="col-sm-1">&nbsp;
							{if $IS_SORTABLE}
								<img src="{$SITEURL}{vimage_path('drag.png')}" class="dragImage" border="0" title="{vtranslate('LBL_DRAG',$QUALIFIED_MODULE)}"/>
							{/if}
						</span>
						<div class="col-sm-9" style="word-wrap: break-word;">
							<div class="fieldLabelContainer row">
