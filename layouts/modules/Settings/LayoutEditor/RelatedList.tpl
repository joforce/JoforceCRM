												...
												<div class="col-sm-5" style="margin-top: 5px;">
													<div class="pull-right">
														{if $RELATION_FIELD->get('_relationType') eq Settings_LayoutEditor_Module_Model::MANY_TO_ONE}
															<img src="{$SITEURL}{vimage_path('N-1.png')}" width="100" height="50" />
														{else}
															<img src="{$SITEURL}{vimage_path('1-1.png')}" width="100" height="50" />
														{/if}
													</div>
												</div>
											</div>
													...
													<li class="relatedModule module_{$MODULE_MODEL->getId()} border1px ONE_TO_MANY"  
														...
														<div class="row">
															<span class="col-sm-1" style="margin-top:18px;">
																<img class="cursorPointerMove" src="{$SITEURL}{vimage_path('drag.png')}" title="{vtranslate('LBL_DRAG',$QUALIFIED_MODULE)}"/>&nbsp;&nbsp;
															</span>
															...
															<div class="col-sm-4" style="margin-top: 4px;">
																<div class="pull-right">
																	{if $MODULE_MODEL->get('relationtype') eq '1:N' and $MODULE_MODEL->getRelationModuleName() neq 'Calendar'}
																		<img src="{$SITEURL}{vimage_path('1-N.png')}" width="100" height="50" />
																	{else}
																		<img src="{$SITEURL}{vimage_path('N-N.png')}" width="100" height="50" />
																	{/if}
																</div>
															</div>
														</div>
										...
										<div>
											<div class="pull-right" style="margin-bottom:20px;">
												<span class="col-sm-6" style="width:100%">
													<img src="{$SITEURL}{vimage_path('Square.png')}" />&nbsp;&nbsp;&nbsp;
													{vtranslate($SELECTED_MODULE_NAME,$SELECTED_MODULE_NAME)}
												</span>
												<span class="col-sm-6" style="width:100%">
													<img src="{$SITEURL}{vimage_path('Circle.png')}" />&nbsp;&nbsp;&nbsp;
