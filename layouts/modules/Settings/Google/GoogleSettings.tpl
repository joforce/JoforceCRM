<div class="configgoogle card"  >  
	   <div class="col-sm-12">
               	<div class="row ">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 editViewHeader card-header-new">
							<h1>Google Calendar Configuration</h1>
						</div>
               	</div>
	</div>
        <br>
	...
	<div class = "settings" style="margin-left:10%;">
		<div class="offset-md-2 col-md-6 mt50">
	...
	<div class="col-sm-12" style="margin-bottom:2%;margin-left:30px">
		...
		<p>5. Select Web Application under Application type, Then you need to enter the required fields. Such as your domain in Authorized JavaScript origins and redirect url (https://www.yourcrm.com/index.php?module=Google&view=List&operation=sync&sourcemodule=Contacts&service=GoogleContacts) in Authorized redirect URIs.</p>
