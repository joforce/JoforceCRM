                        ...
                        <tr data-module-name="Calendar">
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <span class="col-sm-4">
                                        <button type="button" class="btn btn-sm btn-secondary vtButton arrowDown row-fluid" disabled="disabled" style="padding-right: 20px; padding-left: 20px;">
                            ...
                            <tr data-module-name="{$MODULE_MODEL->get('name')}">
                                ...
                                <td class="triggerCustomSharingAccess">
                                    <div class="row">
                                        <span class="col-sm-4">&nbsp;</span>
                                        <span class="col-sm-4">
                                            <button type="button" class="btn btn-sm btn-secondary vtButton" data-handlerfor="fields" data-togglehandler="{$TABID}-rules" style="padding-right: 20px; padding-left: 20px;">
                                                <i class="fa fa-chevron-down"></i>
                                            </button>
                                        </span>
                                    </div>
