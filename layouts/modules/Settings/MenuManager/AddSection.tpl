        ...
        <div class="modal-body">
        	<form class="main-menu-modal-form" action>
					...
					<div style="margin-bottom:10px;" class="row">
                        		 <span class="col-md-4 pull-left mt20">Section Name:</span>
                                         <input class="inputElement col-md-8 m0 p0" name="section-name" id="section-name">
                                 </div>
			
				 <div style="margin-bottom:10px;"  class="row">
	                         	<span class="col-md-4 pull-left mt20">Choose Module:</span>
        	                        <select class="select2 inputElement col-md-8 m0 p0" name="selected-menu" value='' id="select-module">
                	                	<option></option>
				...
				<div style="margin-bottom:10px;"  class="row">
                                         <span class="col-md-4 pull-left mt20"> Font Awesome Icon:</span>
                                         <input class="inputElement col-md-8 m0 p0" name="icon-info" id="icon-info">
                                </div>
                        </div>
        	</form>
	
		<div class="pull-right fa fa-hand-o-right">
        	        <a target="_blank" href="https://www.w3schools.com/icons/fontawesome_icons_webapp.asp">Choose Icon Here</a>
	        </div>
