	...
	<div class="detailViewContainer full-height main-scroll">
			<div class="detailViewTitle form-horizontal" id="profilePageHeader">
				...
				<div class="profileDetailView detailViewInfo">
					...
					<br>
					{assign var="ENABLE_IMAGE_PATH" value="{$SITEURL}{vimage_path('Enable.png')}"}
										...
										<tr>
											...
											<td class="textAlignCenter">
												{if ($PROFILE_MODULE->getFields() && $PROFILE_MODULE->isEntityModule()) || $PROFILE_MODULE->isUtilityActionEnabled()}
													<button type="button" data-handlerfor="fields" data-togglehandler="{$TABID}-fields" class="btn btn-sm btn-secondary" style="padding-right: 20px; padding-left: 20px;">
