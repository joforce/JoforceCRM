...
Head.Class("Settings_Head_OutgoingServer_Js",{},{
	...
	loadContents : function(url) {
		var aDeferred = jQuery.Deferred();
        var params = [];
        params.tab_view = 'OutgoingServerDetail';
        params.url = url;
...
Settings_Head_OutgoingServer_Js("Settings_Head_OutgoingServerEdit_Js",{},{});

Settings_Head_OutgoingServer_Js("Settings_Head_OutgoingServerDetail_Js",{},{});
