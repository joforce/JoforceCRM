 ...
 *************************************************************************************/
Head_AdvanceFilter_Js('Workflows_AdvanceFilter_Js',{},{
    ...
    getMetricFieldSpecificConditionList: function(conditionList, conditionSelected, match, fieldSelected){
        ...
        var fieldModel = Head_Field_Js.getInstance(fieldDataInfo, this.getModuleName());
                            ...
                            if((fieldType == 'date' || fieldType == 'datetime') && valueSelectElement.length > 0) {
                                ...
                                for(i = 0; i < valueArray.length; i++) {
                                    ...
                                    if(!isNaN(dateInstance.getTime())) {
                                        valueArray[i] = app.getDateInHeadFormat('yyyy-mm-dd', dateInstance);
                                    }
                                }
...
Head_Field_Js('Workflows_Field_Js',{},{
...
Head_Date_Field_Js('Workflows_Date_Field_Js',{},{
    ...
    getUi : function() {
        ...
        if(comparatorSelectedOptionVal.length > 0) {
            if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
                ...
                var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Head_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
							<input type="hidden" name="valuetype" value="'+this.get('workflow_valuetype')+'" />';
                return jQuery(html);
...
Head_Date_Field_Js('Workflows_Datetime_Field_Js',{},{
    /**
	 * Function to get the user date format
	 */
    getDateFormat : function(){
...
Head_Currency_Field_Js('Workflows_Currency_Field_Js',{},{
...
Head_Time_Field_Js('Workflows_Time_Field_Js',{},{
...
Head_Owner_Field_Js('Workflows_Ownergroup_Field_Js',{},{
	getUi : function() {
...
Head_Picklist_Field_Js('Workflows_Picklist_Field_Js',{},{
