...
{strip}
   <div class="editViewPageDiv">
      <div class="col-sm-12 col-xs-12 joforce-bg" id="EditView">
                ...
                <div class="editViewContents" style="text-align: center; ">
                  <div class="form-group">
                     ...
                     <div class="col-sm-5 controls">
                        <input class="form-control inputElement" id="name"  name="workflowname" value="{$WORKFLOW_MODEL_OBJ->workflowname}" data-rule-required="true">
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="name" class="col-sm-3 control-label">
                     ...
                     <div class="col-sm-5 controls">
                        <textarea class="form-control inputElement" name="summary" id="summary">{$WORKFLOW_MODEL->get('summary')}</textarea>
                     </div>
                  </div>
                  <div class="form-group">
