								...
								<tr>
									...
									<td style="word-wrap:break-word;">
										...
										{elseif $FIELD_DATA_TYPE eq 'email'}
											<input type="text" class="fieldValue inputElement" name="{$FIELD_MODEL->getName()}" value="{$RECORD_MODEL->get($FIELD_NAME)}" data-validation-engine="validate[funcCall[Head_Email_Validator_Js.invokeValidation]]"/>
										{else}
