...
* All Rights Reserved.
************************************************************************************}
      <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 card" id="settingsmenu-starts">
      <div class="editViewPageDiv mt0">
         <form class="form-horizontal recordEditView joforce-bg mt0 webforms_ipadpro" id="EditView" name="edit" method="post" action="{$SITEURL}index.php" enctype="multipart/form-data">
            <div class="editViewHeader card-header-new p20 mt10 webform_edit_page_style" >
