...
{strip}
    ...
    <div class="row ml20">
        ...
        <div class="col-sm-10 col-xs-10">
            <div class="btn-group">
                <button class="btn btn-secondary selectAllValues" type="button">{vtranslate('LBL_SELECT_ALL_VALUES', $QUALIFIED_MODULE)}</button>
                <button class="btn btn-secondary unSelectAllValues" type="button">{vtranslate('LBL_UNSELECT_ALL_VALUES', $QUALIFIED_MODULE)}</button>
            </div>
        </div>
    </div>
    <br>
