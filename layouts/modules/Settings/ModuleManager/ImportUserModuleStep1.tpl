				...
				<div class="row col-lg-12 col-md-12 col-sm-12" style="margin-top:3%">
					...
					<div class="col-lg-10 col-md-10 col-sm-10">
						...
						<div style="margin-top: 15px;">
							<span name="proceedInstallation" class="fileUploadBtn btn btn-secondary">
								<span><i class="fa fa-laptop"></i> {vtranslate('Select from My Computer', $MODULE)}</span>
								<input type="file" name="moduleZip" id="moduleZip" size="80px" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]"
