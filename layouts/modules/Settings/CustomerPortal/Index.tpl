				...
				<div class="row" style="margin-bottom: 100px;">
							...
							{foreach key=TAB_ID item=MODEL from=$MODULES_MODELS name=moduleModels}
								...
								<li class="portalModuleRow bgColor cp-tabs" {if $smarty.foreach.moduleModels.last} style="border-color: #ddd; border-image: none; border-style: solid; border-width: 0 0 1px 1px;"{/if}
									...
									<a href="javascript:void(0);" class="cp-modules" style="width:100%;">
										<span class="checkbox">
											<img class="drag-portal-module" src="{$SITEURL}layouts/resources/Images/drag.png" border="0" title="Drag And Drop To Reorder Portal Menu In Customer Portal"/>&nbsp;&nbsp;
					...
					<div class="col-sm-9 portal-dashboard">
						<div id="dashboardContent" class="show" >
							...
							<hr class="hrHeader">
							<input type="hidden" name="defaultCharts" value='{Head_Functions::jsonEncode($CHARTS,true)}'/>
							<input type="hidden" name="defaultWidgets" value='{Head_Functions::jsonEncode($WIDGETS,true)}'/>
					...
					<div class="textAlignCenter col-lg-12 col-md-12 col-sm-12">
						<button type="submit" class="btn btn-primary saveButton pull-right" id="savePortalInfo" name="savePortalInfo" type="submit" disabled>{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
					</div>
