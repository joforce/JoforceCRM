...
<script type="text/javascript" src="{vresource_url('layouts/modules/Google/resources/Settings.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/modules/Head/resources/ExtensionCommon.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/modules/Head/resources/Extension.js')}"></script>
