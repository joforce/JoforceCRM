...
Head_Edit_Js("Contacts_Edit_Js", {}, {
	...
	registerReferenceSelectionEvent: function (container) {
		...
		jQuery('input[name="account_id"]', container).on(Head_Edit_Js.referenceSelectionEvent, function (e, data) {
	...
	checkForPortalUser: function (form) {
		...
		if (response) {
			...
			if (primaryEmailValue == "") {
				app.helper.showErrorNotification({
					message: app.vtranslate('JS_PLEASE_ENTER_PRIMARY_EMAIL_VALUE_TO_ENABLE_PORTAL_USER')
				});
				return false;
			}
		}
