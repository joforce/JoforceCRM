...
{strip}
	...
	<td style="text-align:center;">
		...
		&nbsp;<a><img src="{$SITEURL}{vimage_path('drag.png')}" border="0" title="{vtranslate('LBL_DRAG',$MODULE)}"/></a>
