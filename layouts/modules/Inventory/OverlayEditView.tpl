...
<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/modules/Inventory/resources/Edit.js')}"></script>
<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/modules/'|cat:{$MODULE}|cat:'/resources/Edit.js')}"></script>
