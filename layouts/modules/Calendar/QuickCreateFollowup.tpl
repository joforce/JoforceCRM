...
<div class="modal-dialog modelContainer">
	...
	<form class="form-horizontal followupCreateView" id="followupQuickCreate" name="followupQuickCreate" method="post" action="index.php">
		<div class="modal-body">
			...
			{assign var="currentTimeInHeadFormat" value=Head_Time_UIType::getDisplayValue($time)}
			...
			<input class="dateField" type="hidden" name="date_start" value="{$STARTDATE}" data-date-format="{$dateFormat}" data-fieldinfo="{Head_Util_Helper::toSafeHTML(ZEND_JSON::encode($STARTDATEFIELDMODEL))}"/>
