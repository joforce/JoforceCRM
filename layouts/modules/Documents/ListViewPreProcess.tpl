...
<div id="modnavigator" class="module-nav" style='width:42px;'>
...
<div id="sidebar-essentials" class="sidebar-essentials {if $LEFTPANELHIDE eq '1'} hide {/if}"  style="width:242px;left:40px !important;">
