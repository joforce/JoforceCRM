...
{strip}
	<div class="modal-dialog modelContainer">
		...
		<div class="modal-content" style="">
			<form class="form-horizontal recordEditView" name="upload" method="post" enctype="multipart/form-data" action="{$SITEURL}index.php">
					...
					<div class="uploadview-content container-fluid">
						<div class="uploadcontrols">
							<div id="upload" data-filelocationtype="I">
								...
								<div id="dragandrophandler" style="height:auto;" title="{vtranslate('LBL_MAX_UPLOAD_SIZE')} {$MAX_UPLOAD_LIMIT_MB}{vtranslate('MB', $MODULE)}" class="dragdrop-dotted">
									<span class="fa fa-upload document-panel-icon"></span>
									
									<div>
										<div class="fileUploadBtn m0 btn btn-secondary" style="margin: 45px 18px !important;">
