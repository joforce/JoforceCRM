				...
				else
				{
					...
					for(var i=0; i<response.result.languages.length; i++)
					{
						...
						html += '<tr class="md-module-name-translation">'+
								...
								'<td colspan="2"><input type="text" name="module_label_'+language+'" class="md-medium-text-input inputElement" /></td>'+
								'</tr>';
						
						html += '<tr class="md-module-name-translation">'+
								'<td>'+app.vtranslate('LBL_MODULE_NAME_SINGLE_TRANSLATION', MD_QUALIFIED_MODULE_NAME)+' <em>'+language+'</em></td>'+
								'<td colspan="2"><input type="text" name="module_label_single_'+language+'" class="md-medium-text-input inputElement" /></td>'+
								'</tr>';
					}
