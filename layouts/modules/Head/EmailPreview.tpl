                        ...
                        <span class="col-lg-12" style="text-align: center;">
                            <span class="muted">
                                {if $RECORD->get('email_flag') eq "SAVED"}
                                    ...
                                    <span><small><em>&nbsp;{Head_Util_Helper::formatDateTimeIntoDayString($RECORD->get('createdtime'))}</em></small></span>
                                {else}
                                    ...
                                    <span><small><em>&nbsp;{Head_Util_Helper::formatDateTimeIntoDayString($SEND_TIME)}</em></small></span>
                                {/if}
                            </span>
                        </span>
                    </div>
