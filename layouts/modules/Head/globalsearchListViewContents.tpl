...
<div class="col-sm-12 col-xs-12 globle mt20 pl0 pr0">
	...
	<div id="table-content"  class="table-container" style="height:unset !important;">
	<div class="fixed-scroll-table">
		...
		<table id="listview-table" class="table {if $LISTVIEW_ENTRIES_COUNT eq '0'}listview-table-norecords {/if} listview-table">
			...
			<tr class="listViewContentHeader">
			    <th style="color:#909599 !important">
				{if !$SEARCH_MODE_RESULTS}
		    ...
		    <tbody class="overflow-y">
					...
					{/foreach}
						<td class = "listViewRecordActions">
                                                	{include file="ListViewRecordActionsRight.tpl"|vtemplate_path:$MODULE QUICK_PREVIEW_ENABLED=false}
                                                </td>
					</tr>
				{/foreach}
