				...
				<li>
					<div class="">
						<div class="textOverflowEllipsis">
							<a href="{$RELATED_RECORD->getDetailViewUrl()}" id="{$MODULE}_{$RELATED_MODULE}_Related_Record_{$RELATED_RECORD->get('id')}" title="{Head_Util_Helper::getRecordName($RELATED_RECORD->get('id'))}">
                                {Head_Util_Helper::getRecordName($RELATED_RECORD->get('id'))}
							</a>
						</div>
