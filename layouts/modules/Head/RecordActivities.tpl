...
<div class="activityContents ipad_activityContents {$MODULE}" id="activityContentsContainer">
    <div class="card">
        <div class="card-head">
            <div class="card-inner">
                <div class="d-flex flex-center flex-justify-space-between">
                    ...
                    <div class="d-flex flex-justify-end mini-search ml-auto">
                        <a class="btn-link {if $FILTER_TYPE == 'all'}black{/if}" id="all_activity" onclick="Head_Record_Activity_Js.getRecordActivityFilters('all', '')">All</a>
                        <a class="btn-link {if $FILTER_TYPE == 'today'}black{/if}" id="today_activity" onclick="Head_Record_Activity_Js.getRecordActivityFilters('today', '')">Today</a>
                        <a class="btn-link {if $FILTER_TYPE == 'yesterday'}black{/if}" id="yesterday_activity" onclick="Head_Record_Activity_Js.getRecordActivityFilters('yesterday', '')">Yesterday</a>
                        ...
                        <div class="input-group editByDate hide">
                            ...
                            <div class="input-save-wrap">
                                <span class="input-group-addon inlineAjaxSave" onclick="Head_Record_Activity_Js.getRecordActivityFilters('by_date', 'by_date')" style="padding:2px 2px"><i class="fa fa-check"></i></span>
                                <span class="input-group-addon inlineAjaxCancel cancelByDate" style="margin-left:30px;padding:2px 2px"><i class="fa fa-close"></i></span>
                            </div> *}
                            <div class="input-group">
                                <input id="by_date" class="by_date dateField" data-date-format="dd-mm-yyyy">
                                <div class="input-group-append">
                                <button class="btn btn-secondary" onclick="Head_Record_Activity_Js.getRecordActivityFilters('by_date', 'by_date')" type="button" style="bottom:4px;right:10px;">
                    ...
                    <div class="accordian" id="accordionActivity" role="tablist" aria-multiselectable="true">
                        ...
                        {foreach item=ACTIVITYDATE from=$ACTIVITY_DATES key=key}
                            <div class="card">
                                ...
                                <div id="collapse{$i}" class="collapse {if ($key =='0')} show {/if}" role="tabpanel" aria-labelledby="headingOne{$i}" data-parent="#accordionActivity">
                                    <div class="timeline card-body " id="timeline-{$key}">
                                        ...
                                        <div id="loadMoreActivity">Load more ..</div>
                                        <div id="showLessActivity">.. Show less</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
