...
<div class = "quickPreview" id="quick">
        ...
        <div>
            <div class = "quickPreviewModuleHeader row">
                ...
                <div class = "col-lg-2 pull-right">
                    <button class="close" aria-hidden="true" type="button" title="{vtranslate('LBL_CLOSE')}">x</button>
                </div>
            </div>

            <div class="quickPreviewActions clearfix">
                <div class="btn-group pull-left">
                    <button class="btn btn-default btn-xs" onclick="window.location.href = '{$RECORD->getFullDetailViewUrl()}'">
