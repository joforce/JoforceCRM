...
<div class="commentContainer recentComments">
	...
	<a class="show_all_comments" id="show_all_comments" href="">Show All</a>
	...
	{if !empty($COMMENTS)}
		...
		{foreach key=index item=COMMENT from=$COMMENTS}
			...
			<div class="singleComment" {if $COMMENT->get('is_private')}style="background: #fff9ea;"{/if}>
				...
				<div class="col-lg-12">
				    <div class="media">
					<div class="media-left title col-lg-1 col-md-1 col-sm-1">
						...
						{if !empty($IMAGE_PATH)}
						    <img src="{$SITEURL}{$IMAGE_PATH}" width="50px" height="50px" align="left">
						{else}
						    <div class="name"><span><strong> {$CREATOR_NAME|mb_substr:0:2|escape:"html"} </strong></span></div>
						{/if}
					    </div>
					</div>
					<div class="media-body col-lg-11 col-md-4 col-sm-9">
