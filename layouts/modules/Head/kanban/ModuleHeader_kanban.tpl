...
{strip}
	...
	<div class="module-action-content clearfix {$MODULE}-module-action-content">
		...
		{assign var=MODULE_MODEL value=Head_Module_Model::getInstance($SOURCE_MODULE_NAME)}
		...
		{/if}
	    {/if}
	    <div class="col-sm-4 col-md-4 col-lg-4 pull-left" style="margin-top:10px;">
	    ...
	    <div class="col-lg-2 col-md-2 pull-left" style="">
