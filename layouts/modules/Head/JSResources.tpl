...
{strip}
    ...
    <script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/modules/Head/resources/Utils.js')}"></script>
    <script type='text/javascript' src="{$SITEURL}{vresource_url('layouts/modules/Head/resources/validation.js')}"></script>
    <script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/lib/bootbox/bootbox.js')}"></script>
    <script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/modules/Head/resources/Base.js')}"></script>
    <script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/modules/Head/resources/Head.js')}"></script>
    ...
    <script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/resources/v7_client_compat.js')}"></script>
