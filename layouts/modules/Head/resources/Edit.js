 ...
 Head_Index_Js("Head_Edit_Js", {
     ...
     preReferencePopUpOpenEvent: "Head.Referece.Popup.Pre",

     postReferencePopUpOpenEvent: "Head.Referece.Popup.Post",

     referenceSelectionEvent: "Head.Reference.Selection",

     postReferenceSelectionEvent: "Head.PostReference.Selection",

     postReferenceQuickCreateSave: "Head.PostReference.QuickCreateSave",

     refrenceMultiSelectionEvent: "Head.MultiReference.Selection",

     postReferenceQuickCreateSaveEvent: "Head.PostReferenceQuickCreate.Save",

     popupSelectionEvent: "Head.Reference.Popup.Selection",

     referenceDeSelectionEvent: "Head.Reference.Deselection",
     ...
     getInstanceByModuleName: function (moduleName) {
         ...
         if (parentModule == 'Settings') {
             ...
             var fallbackClassName = parentModule + "_Head_Edit_Js";
             if (typeof window[fallbackClassName] == 'undefined') {
                 fallbackClassName = "Head_Edit_Js";
             }
         } else {
             moduleClassName = moduleName + "_Edit_Js";
             fallbackClassName = "Head_Edit_Js";
     ...
     getInstance: function () {
         if (Head_Edit_Js.editInstance == false) {
             var instance = Head_Edit_Js.getInstanceByModuleName();
             Head_Edit_Js.editInstance = instance;
             return instance;
         }
         return Head_Edit_Js.editInstance;
     }
 }, {
     ...
     registerFileElementChangeEvent: function (container) {
         ...
         container.on('change', 'input[name="imagename[]"],input[name="sentdocument"]', function (e) {
             ...
             Head_Edit_Js.file = e.target.files[0];
