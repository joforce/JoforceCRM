...
jQuery.Class("Head_Popup_Js",{
    ...
    getInstance: function(module){
		...
		var fallbackClassName = Head_Popup_Js;
	...
	getPageRecords : function(params){
		...
		Head_BaseList_Js.getPageRecords(params).then(
            function(data){
...
jQuery(document).ready(function() {
	app.event.on("post.Popup.Load",function(event,params){
		...
		var popupInstance = Head_Popup_Js.getInstance(params.module);
