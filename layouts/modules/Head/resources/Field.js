...
jQuery.Class("Head_Field_Js", {
	...
	getUiTypeModel: function () {
		...
		var BasicUiTypeClassName = window["Head_" + typeClassName + "_Field_Js"];
...
Head_Field_Js('Head_Reference_Field_Js', {}, {
...
Head_Field_Js('Head_Picklist_Field_Js', {}, {
	...
	getUi: function () {
		...
		if (picklistColors) {
			...
			for (option in picklistColors) {
				...
				if (picklistColor) {
					className = '.picklistColor_' + fieldName + '_' + option.replace(' ', '_');
					html += className + '{background-color: ' + picklistColor + ' ;}';

					className = className + '.select2-highlighted';
					html += className + '{white: #ffffff !important; background-color: #337ab7 ;}';
				}
			}
			html += '<\style>';
		}
...
Head_Field_Js('Head_Currencylist_Field_Js', {}, {
...
Head_Field_Js('Head_Multipicklist_Field_Js', {}, {
		/**
		 * Function to get the pick list values
		 * @return <object> key value pair of options
		 */
	...
	Head_Field_Js('Head_Boolean_Field_Js', {}, {
...
Head_Field_Js('Head_Date_Field_Js', {}, {
...
Head_Field_Js('Head_Currency_Field_Js', {}, {
...
Head_Field_Js('Head_Owner_Field_Js', {}, {
...
Head_Date_Field_Js('Head_Datetime_Field_Js', {}, {

});

Head_Field_Js('Head_Time_Field_Js', {}, {
...
Head_Field_Js('Head_Text_Field_Js', {}, {
...
Head_Field_Js('Head_Percentage_Field_Js', {}, {
...
Head_Field_Js('Head_Recurrence_Field_Js', {}, {
...
Head_Field_Js('Head_Email_Field_Js', {}, {
...
Head_Field_Js('Head_Image_Field_Js', {}, {
...
Head_Field_Js('Head_Integer_Field_Js', {}, {
	getUi: function () {
		var html = '<input class="inputElement" type="text" name="' + this.getName() + '" data-label="' + this.get('label') + '" data-rule-' + this.getType() + '=true />';
		html = jQuery(html).val(app.htmlDecode(this.getValue()));
		return this.addValidationToElement(html);
