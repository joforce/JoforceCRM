...
jQuery.Class("Head_AdvanceFilter_Js", {
	...
	getFieldSpecificUi: function (fieldSelectElement) {
		...
		if (fieldModel.getType().toLowerCase() == "boolean") {
			...
			var html = '<select class="select2 w-100" name="' + fieldModel.getName() + '">';
			html += '<option value="0"';
			if (selectedValue == '0') {
	...
	addValidationToFieldIfNeeded: function (selectFieldElement) {
		...
		if (this.isFieldSupportsValidation(selectFieldElement)) {
			...
			fieldSpecificElement.addClass('validate[funcCall[Head_Base_Validator_Js.invokeValidation]]')
				.attr('data-validation-engine', 'validate[funcCall[Head_Base_Validator_Js.invokeValidation]]')
			...
			fieldSpecificElement.removeClass('validate[funcCall[Head_Base_Validator_Js.invokeValidation]]')
...
Head_Field_Js('AdvanceFilter_Field_Js', {}, {
...
Head_Currencylist_Field_Js('AdvanceFilter_Currencylist_Field_Js', {}, {
	/**
...
Head_Picklist_Field_Js('AdvanceFilter_Picklist_Field_Js', {}, {
	...
	getUi: function () {
		...
		if (comparatorSelectedOptionVal == 'e' || comparatorSelectedOptionVal == 'n') {
			var html = '<select class="select2 w-100" multiple name="' + this.getName() + '[]">';
			...
			var html = '<input type="hidden" class="w-100 select2 mt10" name="' + this.getName() + '">';
...
Head_Multipicklist_Field_Js('AdvanceFilter_Multipicklist_Field_Js', {}, {
	...
	getUi: function () {
		...
		if (comparatorSelectedOptionVal != 'e' && comparatorSelectedOptionVal != 'n') {
			...
			var html = '<input type="hidden" class="row-fluid w-100 select2 mt10" name="' + this.getName() + '[]">';
			var selectContainer = jQuery(html).val(selectedOption);
			selectContainer.data('tags', tagsArray).data('picklistvalues', pickListValuesArrayFlip);
			this.addValidationToElement(selectContainer);
			return selectContainer;
...
Head_Owner_Field_Js('AdvanceFilter_Owner_Field_Js', {}, {
	getUi: function () {
		var comparatorSelectedOptionVal = this.get('comparatorElementVal');
		if (comparatorSelectedOptionVal == 'e' || comparatorSelectedOptionVal == 'n') {
			var html = '<select class="select2 w-100 row-fluid" multiple name="' + this.getName() + '[]">';
			var pickListValues = this.getPickListValues();
			var selectedOption = app.htmlDecode(this.getValue());
			var selectedOptionsArray = selectedOption.split(',')
			...
			var html = '<input data-tags="' + tagsArray + '" type="hidden" class="row-fluid w-100 select2 mt10" name="' + this.getName() + '">';
			var selectContainer = jQuery(html).val(selectedOption);
...
Head_Owner_Field_Js('Head_Ownergroup_Field_Js', {}, {
	getUi: function () {
...
Head_Date_Field_Js('AdvanceFilter_Date_Field_Js', {}, {
	/**
	 * Function to get the ui
