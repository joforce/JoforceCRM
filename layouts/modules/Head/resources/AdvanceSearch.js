...
Head_BasicSearch_Js("Head_AdvanceSearch_Js",{
	...
	getAdvanceSearch : function() {
		...
		//Exists in the cache
		if(searchModule in Head_AdvanceSearch_Js.cache) {
			aDeferred.resolve(Head_AdvanceSearch_Js.cache[searchModule]);
		...
		app.request.post({data:searchableModulesParams}).then(
			function(err, data){
				...
				//add to cache
				Head_AdvanceSearch_Js.cache[searchModule] = data;
		...
		this.getAdvanceSearch().then(
			function(data){
                thisInstance.showAdvanceSearch(data).then(function(){
                    ...
                    thisInstance.advanceFilter = new Head_SearchAdvanceFilter_Js(jQuery('.filterContainer'));
    ...
    initiateListInstance : function(container)   {
        var listInstance = new Head_AdvanceSearchList_Js();
