...
-->*}
{strip}
{assign var="FIELD_INFO" value=Head_Util_Helper::toSafeHTML(Zend_Json::encode($FIELD_MODEL->getFieldInfo()))}
...
data-validation-engine="validate[funcCall[Head_Base_Validator_Js.invokeValidation]]" data-fieldinfo='{$FIELD_INFO}'
