...
<div class="col-lg-12 col-md-12 col-sm-12">
	...
	<div class="col-lg-2 col-md-2 col-sm-2 white-background m0">
	    ...
	    <div class="media-body">
	    	...
	    	<p class="text-muted"><i class="mdi mdi-office-building"></i>{$RECORD->get('account_type')}</p>
	...
	<div class="col-lg-3 col-md-3 col-sm-3 white-background m0">
		...
		<a href="mailto:{$RECORD->get('email1')}">{$RECORD->get('email1')}&nbsp;<i class="fa fa-envelope" aria-hidden="true"></i></a>
		...
		<span>{$FIELDS_MODELS_LIST['account_id']->getDisplayValue($RECORD->get('account_id'))}<i class="fa fa-building" aria-hidden="true"></i></span>
	    </div>
	</div>
