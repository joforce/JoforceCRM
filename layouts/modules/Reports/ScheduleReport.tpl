...
{strip}
    ...
    {if $show_report_scheduled eq true}
        <div id="scheduleBox" class='col-lg-12 row card card-body contentsBackground schedule_page_style {if $SCHEDULEDREPORTS->get('scheduleid') eq ''} hide {/if}'>
            <div class='col-lg-6 pull-left' style="padding:5px 0px;">
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>{vtranslate('LBL_RUN_REPORT', $MODULE)}</div>
                <div class='col-lg-6 pull-left'>
                    {assign var=scheduleid value=$SCHEDULEDREPORTS->get('scheduleid')}
                    <select class='select2 inputElement' id='schtypeid' name='schtypeid' style="">
            ...
            <div class='col-lg-6 pull-left {if $scheduleid neq 2} hide {/if}' id='scheduledWeekDay' style='padding:5px 0px;'>
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>{vtranslate('LBL_ON_THESE_DAYS', $MODULE)}</div>
                <div class='col-lg-6 pull-left'>
                    {assign var=dayOfWeek value=Zend_Json::decode($SCHEDULEDREPORTS->get('schdayoftheweek'))}
                    <select style='' multiple class='select2 w-100'  name='schdayoftheweek' data-rule-required="true" id='schdayoftheweek'>
            ...
            <div class='col-lg-6 pull-left {if $scheduleid neq 3} hide {/if}' id='scheduleMonthByDates' style="padding:5px 0px;">
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>{vtranslate('LBL_ON_THESE_DAYS', $MODULE)}</div>
                <div class='col-lg-6 pull-left'>
                    {assign var=dayOfMonth value=Zend_Json::decode($SCHEDULEDREPORTS->get('schdayofthemonth'))}
                    <select style="" multiple class="select2 w-100" data-rule-required="true"  name='schdayofthemonth' id='schdayofthemonth' >
            ...
            {* show specific date *}
            <div class='col-lg-6 pull-left  {if $scheduleid neq 5} hide {/if}' id='scheduleByDate' style="padding:5px 0px;">
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>{vtranslate('LBL_CHOOSE_DATE', $MODULE)}</div>
                <div class='col-lg-6 pull-left'>
                    <div class="input-group date" style="margin-bottom: 3px">
                        ...
                        <span class="input-group-addon new-icon-data"><i class="fa fa-calendar "></i></span>
                    </div>
                </div>
            </div>
            {* show month view by anually *}
            <div class='col-lg-6 pull-left  {if $scheduleid neq 4} hide {/if}' id='scheduleAnually' style='padding:5px 0px;'>
                <div class='col-lg-6' style='position:relative;top:5px;'>
                ...
                <div class='col-lg-6 pull-left'>
                    ...
                    <div>
                        ...
                        <select multiple class="select2 inputElement" id='annualDates' name='schannualdates' data-rule-required="true"  data-date-format="{$CURRENT_USER->date_format}">
            ...
            <div class='col-lg-6 pull-left' id='scheduledTime' style='padding:5px 0px 10px 0px;'>
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>
                    {vtranslate('LBL_AT_TIME', $MODULE)}<span class="redColor">*</span>
                </div>
                <div class='col-lg-6 pull-left' id='schtime'>
                    <div class='input-group time'>
						<input type='text' class='timepicker-default form-control ui-timepicker-input inputElement' data-format='{$CURRENT_USER->get('hour_format')}' name='schtime' value="{$SCHEDULEDREPORTS->get('schtime')}" data-rule-required="true" data-rule-time="true" />
							<span class="input-group-addon new-icon-data"><i class="fa fa-clock-o"></i></span>
                    </div>
                </div>
            </div>
            {* show all the users,groups,roles and subordinat roles*}
            <div class='col-lg-6 pull-left' id='recipientsList' style='padding:5px 0px 10px 0px;'>
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>
                ...
                <div class='col-lg-6 pull-left'>
                    ...
                    <select multiple class="select2 w-100" id='recipients' name='recipients' data-rule-required="true" style="">
            ...
            <div class='col-lg-6 pull-left' id='specificemailsids' style='padding:5px 0px 10px 0px;'>
                <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>
                ...
                <div class='col-lg-6 pull-left'>
                    ...
                    <input id="specificemails" style="" class="inputElement" type="text" value="{$specificemailids}" name="specificemails" data-validation-engine="validate[funcCall[Head_MultiEmails_Validator_Js.invokeValidation]]"></input>
                </div>
            </div>
            {if $TYPE neq 'Chart'}
                <div class='col-lg-6 pull-left' id='fileformat' style='padding:5px 0px 10px 0px;'>
                    <div class='col-lg-6 pull-left' style='position:relative;top:5px;'>
                        {vtranslate('LBL_FILE_FORMAT', $MODULE)}
                    </div>
                    <div class='col-lg-6 pull-left'>
                        <select class="select2 inputElement" id='fileformat' name='fileformat' data-validation-engine="validate[required,funcCall[Head_Base_Validator_Js.invokeValidation]]" >
            ...
            {if $SCHEDULEDREPORTS->get('next_trigger_time')}
                <div class="col-lg-6 pull-left" style="padding:5px 0px 10px 0px;">
                    <div class='col-lg-6 pull-left'>
