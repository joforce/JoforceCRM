...
<input type='hidden' name='data' value='{Head_Functions::jsonEncode($DATA)}' />
...
<div class="dashboardWidgetContent">
    ...
    <div class='border1px filterConditionContainer' style="padding:30px;">
        <div id='chartcontent' name='chartcontent' style="min-height:300px;" data-mode='Reports'></div>
                <canvas id="chart-area9" height='120px;' style='position:absolute;height:200px;top:350px;'/>
        ...
        {if $REPORT_MODEL->isInventoryModuleSelected()}
            <div class="alert alert-info">
                {assign var=BASE_CURRENCY_INFO value=Head_Util_Helper::getUserCurrencyInfo()}
