...
<script type="text/javascript">
    {$CLASS_NAME}('Head_ChartReportWidget_{$RECORD_ID}',{}, {
        init: function () {
            this._super(jQuery(".quickPreviewSummary"));
        }
    });

    var i = new Head_ChartReportWidget_{$RECORD_ID}();
    jQuery('.quickPreviewSummary').trigger(Head_Widget_Js.widgetPostLoadEvent);
</script>
