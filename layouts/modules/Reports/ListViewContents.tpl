										...
										<span class="fieldValue">
											<span class="value textOverflowEllipsis">
												...
												{else if $LISTVIEW_HEADERNAME eq 'primarymodule'}
													{Head_Util_Helper::tosafeHTML(decode_html(vtranslate($LISTVIEW_ENTRY_VALUE, $LISTVIEW_ENTRY_VALUE)))}
												{else if $LISTVIEW_HEADERNAME eq 'foldername'}
													{Head_Util_Helper::tosafeHTML(vtranslate($LISTVIEW_ENTRY_VALUE, $MODULE))}
												{else}
													{Head_Util_Helper::tosafeHTML($LISTVIEW_ENTRY_VALUE)}
												{/if}
											</span>
										</span>
										</span>
