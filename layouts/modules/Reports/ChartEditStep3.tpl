...
{strip}
    <form class="form-horizontal recordEditView padding1per" id="chart_report_step3" method="post" action="index.php">
        ...
        <input type="hidden" name="reportname" value="{Head_Util_Helper::toSafeHTML($REPORT_MODEL->get('reportname'))}" >
        ...
        <input type="hidden" name="reports_description" value="{Head_Util_Helper::toSafeHTML($REPORT_MODEL->get('reports_description'))}" >
                        ...
                        <ul class="nav nav-tabs charttabs" name="charttab" style="text-align:center;font-size:14px;font-weight: bold;margin:0 3%;border:0px">
                            <li class="active marginRight5px" >
                                <a data-type="pieChart" data-toggle="tab">
                                    <div><img src="{$SITEURL}layouts/skins/images/pie.PNG" style="border:1px solid #ccc;"/></div>
                            ...
                            <li class="marginRight5px">
                                <a data-type="verticalbarChart" data-toggle="tab">
                                    <div><img src="{$SITEURL}layouts/skins/images/vbar.PNG" style="border:1px solid #ccc;"/></div>
                                    <div class="chartname">{vtranslate('LBL_VERTICAL_BAR_CHART', $MODULE)}</div>
                                </a>
                            </li>
                            <li class="marginRight5px">
                                <a data-type="horizontalbarChart" data-toggle="tab">
                                    <div><img src="{$SITEURL}layouts/skins/images/hbar.PNG" style="border:1px solid #ccc;"/></div>
                                    <div class="chartname">{vtranslate('LBL_HORIZONTAL_BAR_CHART', $MODULE)}</div>
                                </a>
                            </li>
                            <li class="marginRight5px" >
                                <a data-type="lineChart" data-toggle="tab">
                                    <div><img src="{$SITEURL}layouts/skins/images/line.PNG" style="border:1px solid #ccc;"/></div>
        ...
        <div class="modal-overlay-footer border1px clearfix">
            <div class="row clearfix">
                <div class="textAlignCenter col-lg-12 col-md-12 col-sm-12 ">
                    <button type="button" class="btn back-button backStep"><strong>{vtranslate('LBL_BACK',$MODULE)}</strong></button>&nbsp;&nbsp;
