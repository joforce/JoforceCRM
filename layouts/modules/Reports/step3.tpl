...
-->*}
{strip}
    <form class="form-horizontal recordEditView" id="report_step3" method="post" action="{$SITEURL}index.php">
        ...
        <input type="hidden" name="reports_description" value="{Head_Util_Helper::toSafeHTML($REPORT_MODEL->get('description'))}" />
