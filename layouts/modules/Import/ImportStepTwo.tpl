            ...
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td width="6%">
                            <div align="center">
                                <button class="btn btn-default btn-lg" onClick ="return Head_Import_Js.copySelectedOptions('#available_fields', '#selected_merge_fields')"><span class="fa fa-chevron-right"></span></button>
                                <button class="btn btn-default btn-lg" onClick ="return Head_Import_Js.removeSelectedOptions('#selected_merge_fields')"><span class="fa fa-chevron-left"></span></button>
                            </div>
                        </td>
                        <td>
