...
<div class='editViewContainer'>
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php">
		...
		<table class="table table-bordered blockContainer showInlineTable">
			<tr>
				<th class="blockHeader" colspan="4">{vtranslate('SINGLE_VTPDFMaker', $MODULE)}</th>
			</tr>
			<tr>
			...
			<tr>
                ...
                <div class="tab-pane inactive" id="division2">
                    <table class="table table-bordered blockContainer showInlineTable">
                        <tr>
                           <th class="blockHeader" colspan="4">{vtranslate('Company Details', $MODULE)}</th>
                        </tr>
                        <tr>  
                ...
                <table class="table table-bordered blockContainer showInlineTable">
                        <tr>
                                <th class="blockHeader" colspan="4">{vtranslate('General Fields', $MODULE)}</th>
                        </tr>
                        <tr>
         ...
         <div class="tab-pane inactive" id="division3">
             <table class="table table-bordered blockContainer showInlineTable">
                <tr>
                    <th class="blockHeader" colspan="4">{vtranslate('Product Block', $MODULE)}</th>
                </tr>
		<tr>
         ...
         <div class="tab-pane inactive" id="division4">
              <table class="table table-bordered blockContainer showInlineTable">
                <tr>
                    <th class="blockHeader" colspan="4">{vtranslate('Header/Footer', $MODULE)}</th>
                </tr>
                <tr>
         ...
         <div class="tab-pane inactive" id="division5">
              <table class="table table-bordered blockContainer showInlineTable">
                <tr>
                    <th class="blockHeader" colspan="4">{vtranslate('PDF Settings', $MODULE)}</th>
                </tr>
                <tr>
