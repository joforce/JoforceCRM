jQuery.Class("VTPDFMaker_Helper_Js", {
	...
	if(selected_template == 'Select Template' || selected_template == null)
        	Vtiger_Helper_Js.showPnotify('Please select a template to export', 'failure');
	else
		window.location.href='index.php?module=VTPDFMaker&view=DownloadPDF&recordId=' + recordId +'&selected_template='+selected_template+'&sourceModule='+source_module;
    },
...
$(document).ready(function() {
    ...
    $('head').append('<link rel="stylesheet" href="layouts/vlayout/modules/VTPDFMaker/public/css/font-awesome.css" type="text/css" />');
   ...
   if (window.location.href.indexOf("view") > -1) {
	...
	var module = app.getModuleName();
        ...
        urldata = {
            "type": "POST",
            "data": 'module=VTPDFMaker&action=AddSideBar&moduleName=' + module+'&type='+type,
            "url": 'index.php'
        }
