...
Head_Helper_Js.showPnotify = function (params) {
...
Head_Helper_Js.showMessage = function (params) {
	Head_Helper_Js.showPnotify(params);
};

Head_List_Js.prototype.registerTimeListSearch = function (container) {
	vtUtils.registerEventForTimeFields(container);
};

Head_List_Js.prototype.registerDateListSearch = function (container) {
	vtUtils.registerEventForDateFields(container);
};

Head_List_Js.prototype.calculatePages = function () {
...
Head_List_Js.prototype.checkSelectAll = function () {
	var state = true;
...
Head_List_Js.prototype.registerChangeCustomFilterEvent = function () {
	var thisInstance = this;
...
Head_List_Js.prototype.getListViewContentContainer = function () {
	return this.getListViewContainer();
};

Head_Popup_Js.prototype.show = function (params, callback) {
...
Head_Popup_Js.prototype.calculatePages = function () {
	var thisInstance = this;
	var aDeferred = jQuery.Deferred();
	var totalNumberOfRecords = jQuery('.totalNumberOfRecords');
	thisInstance.totalNumOfRecords(totalNumberOfRecords);
