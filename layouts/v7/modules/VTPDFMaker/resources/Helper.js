jQuery.Class("VTPDFMaker_Helper_Js", {
    exportPDF: function(recordId) {
        ...
        if(selected_template == 'Select Template' || selected_template == null)
                ...
                window.location.href=site_url+'index.php?module=VTPDFMaker&view=DownloadPDF&recordId=' + recordId +'&selected_template='+selected_template+'&sourceModule='+source_module;
    },
