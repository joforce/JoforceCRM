...
<html>
	<head>
		<title>{if $PAGETITLE eq 'Vtiger'}{vtranslate('JoForce', $QUALIFIED_MODULE)}{else}{vtranslate($PAGETITLE, $QUALIFIED_MODULE)}{/if}</title>
        <link rel="SHORTCUT ICON" href="{$SITEURL}layouts/v7/skins/images/favicon.ico">
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />

		<link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/todc/css/bootstrap.min.css'>
		<link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/todc/css/docs.min.css'>
		<link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/todc/css/todc-bootstrap.min.css'>
		<link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/font-awesome/css/font-awesome.min.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/jquery/select2/select2.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/select2-bootstrap/select2-bootstrap.css'>
        ...
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/jquery/jquery-ui-1.11.3.custom/jquery-ui.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/vt-icons/style.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/animate/animate.min.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/jquery/malihu-custom-scrollbar/jquery.mCustomScrollbar.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/jquery/jquery.qtip.custom/jquery.qtip.css'>
        <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/lib/jquery/daterangepicker/daterangepicker.css'>
         <link type='text/css' rel='stylesheet' href='{$SITEURL}layouts/v7/skins/custom.css'>
		...
		<script src="{$SITEURL}{vresource_url('layouts/v7/lib/jquery/jquery.min.js')}"></script>
		<script src="{$SITEURL}{vresource_url('layouts/v7/lib/jquery/jquery-migrate-1.0.0.js')}"></script>
