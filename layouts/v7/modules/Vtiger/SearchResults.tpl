...
{strip}
	<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/v7/modules/Vtiger/resources/List.js')}"></script>
	<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/v7/modules/Vtiger/resources/SearchList.js')}"></script>
