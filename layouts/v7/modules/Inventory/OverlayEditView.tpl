...
<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/v7/modules/Inventory/resources/Edit.js')}"></script>
<script type="text/javascript" src="{$SITEURL}{vresource_url('layouts/v7/modules/'|cat:{$MODULE}|cat:'/resources/Edit.js')}"></script>
