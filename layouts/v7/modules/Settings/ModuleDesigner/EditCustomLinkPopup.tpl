...
<tr>
	<td><img src="{$SITEURL}layouts/v7/modules/Settings/{$MODULE}/assets/images/icon.png" alt="{vtranslate('LBL_CUSTOM_LINK_ICON_ALT', $QUALIFIED_MODULE)}" /> {vtranslate("LBL_CUSTOM_LINK_ICON", $QUALIFIED_MODULE)}</td>
	<td><input type="text" name="icon" size="50" value="{vtranslate($a_customLink.icon)}" /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/v7/modules/Settings/{$MODULE}/assets/images/handler-path.png" alt="{vtranslate('LBL_CUSTOM_LINK_HANDLER_PATH_ALT', $QUALIFIED_MODULE)}" /> {vtranslate("LBL_CUSTOM_LINK_HANDLER_PATH", $QUALIFIED_MODULE)}</td>
	<td colspan="2"><input type="text" name="handler_path" size="50" value="{$a_customLink.handlerPath}" /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/v7/modules/Settings/{$MODULE}/assets/images/handler-class.png" alt="{vtranslate('LBL_CUSTOM_LINK_HANDLER_CLASS_ALT', $QUALIFIED_MODULE)}" /> {vtranslate("LBL_CUSTOM_LINK_HANDLER_CLASS", $QUALIFIED_MODULE)}</td>
