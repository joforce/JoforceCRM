...
function md_addField(o_field, isImporting)
{
	...
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.mandatory ? 'mandatory' : 'mandatory-bw')+'.png" class="'+(o_field.mandatory ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.isEntityIdentifier ? 'entityidentifier' : 'entityidentifier-bw')+'.png" class="'+(o_field.isEntityIdentifier ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.inFilterAll ? 'filterall' : 'filterall-bw')+'.png" class="'+(o_field.inFilterAll ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.inPopup ? 'popup' : 'popup-bw')+'.png" class="'+(o_field.inPopup ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.inRelatedList ? 'related' : 'related-bw')+'.png" class="'+(o_field.inRelatedList ? 'md-icon-active' : 'md-icon-inactive')+'" /><br /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.quickCreate ? 'create' : 'create-bw')+'.png" class="'+(o_field.quickCreate ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.massEditable ? 'massedit' : 'massedit-bw')+'.png" class="'+(o_field.massEditable ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.defaultValue != '' ? 'defaultvalue' : 'defaultvalue-bw')+'.png" class="'+(o_field.defaultValue != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.helpInfoLabel != '' ? 'helpinfo' : 'helpinfo-bw')+'.png" class="'+(o_field.helpInfoLabel != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_field.readOnly ? 'readonly' : 'readonly-bw')+'.png" class="'+(o_field.readOnly != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '</div>';
	row += '</li>';
...
function md_addCustomLink(o_customLink, isImporting)
{
	...
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_customLink.icon != '' ? 'icon' : 'icon-bw')+'.png" class="'+(o_customLink.icon != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_customLink.handlerPath != '' ? 'handler-path' : 'handler-path-bw')+'.png" class="'+(o_customLink.handlerPath != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_customLink.handlerClass != '' ? 'handler-class' : 'handler-class-bw')+'.png" class="'+(o_customLink.handlerClass != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_customLink.handler != '' ? 'handler' : 'handler-bw')+'.png" class="'+(o_customLink.handler != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '</div>';
...
function md_addRelatedList(o_relatedList, isImporting)
{
	...
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_relatedList.presence == 1 ? 'presence' : 'presence-bw')+'.png" class="'+(o_relatedList.presence == 1 ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_relatedList.actionAdd ? 'add' : 'add-bw')+'.png" class="'+(o_relatedList.actionAdd ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_relatedList.actionSelect ? 'select' : 'select-bw')+'.png" class="'+(o_relatedList.actionSelect != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '</div>';
...
function md_addEvent(o_event, isImporting)
{
	...
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_event.isActive ? 'active' : 'active-bw')+'.png" class="'+(o_event.isActive ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_event.cond != '' ? 'cond' : 'cond-bw')+'.png" class="'+(o_event.cond != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '<img src="'+site_url+'layouts/v7/modules/Settings/'+MD_MODULE_NAME+'/assets/images/'+(o_event.dependentOn != '' ? 'dependent' : 'dependent-bw')+'.png" class="'+(o_event.dependentOn != '' ? 'md-icon-active' : 'md-icon-inactive')+'" /> ';
	row += '</div>';
