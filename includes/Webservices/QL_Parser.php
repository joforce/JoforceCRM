<?php
/* Driver template for the PHP_QL_ParserrGenerator parser generator. (PHP port of LEMON)
*/
 ...
 */
class QL_ParseryyToken implements ArrayAccess
{
    public $string = '';
    ...
    {
        if ($s instanceof QL_ParseryyToken) {
            $this->string = $s->string;
            $this->metadata = $s->metadata;
        } else {
            $this->string = (string) $s;
            if ($m instanceof QL_ParseryyToken) {
    ...
    function offsetSet($offset, $value)
    {
        if ($offset === null) {
            if (isset($value[0])) {
                $x = ($value instanceof QL_ParseryyToken) ?
        ...
        if ($value instanceof QL_ParseryyToken) {
            if ($value->metadata) {
...
#line 451 "e:\workspace\nonadmin\pkg\vtiger\extensions\Webservices\QL_Parser.y"
class QL_Parser #line 102 "e:\workspace\nonadmin\pkg\vtiger\extensions\Webservices\QL_Parser.php"
{
...
*/
    ...
    static public $yy_default = array(
        /*     0 */
        100,   77,   91,   64,   77,   71,  100,   94,  100,  100,
...
*/
    ...
    function yy_shift($yyNewState, $yyMajor, $yypMinor)
    {
        ...
        $yytos = new QL_ParseryyStackEntry;
    ...
    */
    ...
    function yy_r17()
    {
        ...
        if (
            strcasecmp($this->out['where_condition']['column_operators'][$pos], "in") === 0 &&
    ...
    function yy_reduce($yyruleno)
    {
        ...
        //QL_ParseryyStackEntry $yymsp;            /* The top of the parser's stack */
        //int $yysize;                     /* Amount to pop the stack */
        $yymsp = $this->yystack[$this->yyidx];
        if (
            self::$yyTraceFILE && $yyruleno >= 0
