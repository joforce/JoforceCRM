...
// $ANTLR 3.1 EventConditionParser.g 2009-01-23 20:13:10              

class EventConditionParserParser extends AntlrParser {
    ...
    public function getTokenNames() { return EventConditionParserParser::$tokenNames; }
    public function getGrammarFileName() { return "EventConditionParser.g"; }
    ...
    ///* EventConditionParser.g:33:1: statement returns [result] : (exp= comparision | exp= inclause ) ; */
    ...
    ///* EventConditionParser.g:35:1: comparision returns [result] : lhs= SYMBOL '==' rhs= value ; */
    public function comparision(){
        ...
        try {
            ...
            if ($this->state->failed) return $result;
            if ( $this->state->backtracking==0 ) {
              $result=array('==', new EventConditionSymbol(($lhs!=null?$lhs->getText():null)), $rhs); echo $value;
            }
    ...
    ///* EventConditionParser.g:38:1: inclause returns [result] : lhs= SYMBOL IN rhs= listelement ; */
    public function inclause(){
        ...
        try {
            ...
            if ($this->state->failed) return $result;
            if ( $this->state->backtracking==0 ) {
              $result=array('in', new EventConditionSymbol(($lhs!=null?$lhs->getText():null)), $rhs);
            }
    ...
    ///* EventConditionParser.g:40:1: listelement returns [result] : '[' val= value ( ',' val= value )* ']' ; */
    ...
    // $ANTLR start "value"
    ///* EventConditionParser.g:44:1: value returns [result] : val= STRING ; */
...
EventConditionParserParser::$FOLLOW_comparision_in_statement57 = new Set(array(1));
EventConditionParserParser::$FOLLOW_inclause_in_statement63 = new Set(array(1));
EventConditionParserParser::$FOLLOW_SYMBOL_in_comparision78 = new Set(array(13));
EventConditionParserParser::$FOLLOW_13_in_comparision80 = new Set(array(6));
EventConditionParserParser::$FOLLOW_value_in_comparision84 = new Set(array(1));
EventConditionParserParser::$FOLLOW_SYMBOL_in_inclause101 = new Set(array(5));
EventConditionParserParser::$FOLLOW_IN_in_inclause103 = new Set(array(14));
EventConditionParserParser::$FOLLOW_listelement_in_inclause107 = new Set(array(1));
EventConditionParserParser::$FOLLOW_14_in_listelement122 = new Set(array(6));
EventConditionParserParser::$FOLLOW_value_in_listelement126 = new Set(array(15, 16));
EventConditionParserParser::$FOLLOW_15_in_listelement137 = new Set(array(6));
EventConditionParserParser::$FOLLOW_value_in_listelement141 = new Set(array(15, 16));
EventConditionParserParser::$FOLLOW_16_in_listelement147 = new Set(array(1));
EventConditionParserParser::$FOLLOW_STRING_in_value162 = new Set(array(1));
