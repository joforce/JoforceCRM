...
// $ANTLR 3.1 EventConditionParser.g 2009-01-23 20:13:11
      
function EventConditionParserLexer_DFA9_static(){
    $eotS =
...
$EventConditionParserLexer_DFA9 = EventConditionParserLexer_DFA9_static();

class EventConditionParserLexer_DFA9 extends DFA {

    public function __construct($recognizer) {
        global $EventConditionParserLexer_DFA9;
        $DFA = $EventConditionParserLexer_DFA9;
...
class EventConditionParserLexer extends AntlrLexer {
    static $INTEGER=8;
    static $T__16=16;
    static $IN=5;
    static $T__15=15;
    ...
    function __construct($input, $state=null){
        parent::__construct($input,$state);
            ...
            $this->dfa9 = new EventConditionParserLexer_DFA9($this);
    }
    function getGrammarFileName() { return "EventConditionParser.g"; }

    // $ANTLR start "T__13"
    function mT__13(){
        try {
            $_type = EventConditionParserLexer::$T__13;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchString("=="); 
    ...
    function mT__14(){
        try {
            $_type = EventConditionParserLexer::$T__14;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchChar(91); 
    ...
    function mT__15(){
        try {
            $_type = EventConditionParserLexer::$T__15;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchChar(44); 
    ...
    function mT__16(){
        try {
            $_type = EventConditionParserLexer::$T__16;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchChar(93); 
    ...
    function mIN(){
        try {
            $_type = EventConditionParserLexer::$IN;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
    ...
    function mINTEGER(){
        try {
            $_type = EventConditionParserLexer::$INTEGER;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $cnt1=0;
            //loop1:
    ...
    function mSTRING(){
        try {
            $_type = EventConditionParserLexer::$STRING;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchChar(39); 
            $cnt2=0;
    ...
    function mSYMBOL(){
        try {
            $_type = EventConditionParserLexer::$SYMBOL;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            $alt5=2;
    ...
    function mDOT(){
        try {
            $_type = EventConditionParserLexer::$DOT;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $this->matchChar(46); 
    ...
    function mELEMENT_ID(){
        try {
            $_type = EventConditionParserLexer::$ELEMENT_ID;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $cnt6=0;
            //loop6:
    ...
    function mWHITESPACE(){
        try {
            $_type = EventConditionParserLexer::$WHITESPACE;
            $_channel = EventConditionParserLexer::$DEFAULT_TOKEN_CHANNEL;
            {
            $cnt8=0;
            //loop8:
