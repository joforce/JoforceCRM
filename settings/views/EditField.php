...
class Settings_ModuleDesigner_EditField_View extends Settings_Head_Index_View
{
	...
	{	
		...
		else
		{
			...
			$query = "SELECT tablabel FROM jo_tab ORDER BY tablabel ASC";
	...
	{
		$defaultTable = "jo_".strtolower($moduleName);
