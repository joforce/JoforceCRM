...
class crmattachment extends rcube_plugin {
	...
	public function getDetails() {
		...
		$index = 0;
		$sql_result = $db->query("SELECT vtiger_attachments.* FROM vtiger_attachments JOIN vtiger_seattachmentsrel ON vtiger_seattachmentsrel.attachmentsid=vtiger_attachments.attachmentsid WHERE vtiger_seattachmentsrel.crmid IN ($ids);");
