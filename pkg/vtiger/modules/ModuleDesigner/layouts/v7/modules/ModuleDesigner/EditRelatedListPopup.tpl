...
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/presence.png" alt="{vtranslate("LBL_RELATED_LIST_PRESENCE_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_RELATED_LIST_PRESENCE", $QUALIFIED_MODULE)}</td>
...
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/add.png" alt="{vtranslate("LBL_RELATED_LIST_ACTION_ADD_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_RELATED_LIST_ACTION_ADD", $QUALIFIED_MODULE)}</td>
	<td><input type="checkbox" name="action_add" value="1" {if $a_relatedList.actionAdd}checked="checked"{/if} /></td>
</tr>
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/select.png" alt="{vtranslate("LBL_RELATED_LIST_ACTION_SELECT_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_RELATED_LIST_ACTION_SELECT", $QUALIFIED_MODULE)}</td>
