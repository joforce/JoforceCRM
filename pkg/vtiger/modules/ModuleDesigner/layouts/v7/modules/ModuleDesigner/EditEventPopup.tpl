...
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/handler-path.png" alt="{vtranslate("LBL_EVENT_HANDLER_PATH_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_EVENT_HANDLER_PATH", $QUALIFIED_MODULE)}</td>
	<td><input type="text" name="handler_path" size="50" value="{$a_event.handlerPath}" /></td>
</tr>
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/handler-class.png" alt="{vtranslate("LBL_EVENT_HANDLER_CLASS_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_EVENT_HANDLER_CLASS", $QUALIFIED_MODULE)}</td>
	<td><input type="text" name="handler_class" size="50" value="{$a_event.handlerClass}" /></td>
</tr>
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/cond.png" alt="{vtranslate("LBL_EVENT_COND_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_EVENT_COND", $QUALIFIED_MODULE)}</td>
	<td><input type="text" name="cond" size="50" value="{$a_event.cond}" /></td>
</tr>
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/dependent.png" alt="{vtranslate("LBL_EVENT_DEPENDENT_ON_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_EVENT_DEPENDENT_ON", $QUALIFIED_MODULE)}</td>
	<td><input type="text" name="dependent_on" size="50" value="{$a_event.dependentOn}" /></td>
</tr>
<tr>
	<td><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/active.png" alt="{vtranslate("LBL_EVENT_IS_ACTIVE_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_EVENT_IS_ACTIVE", $QUALIFIED_MODULE)}</td>
