<!--<h2><img src="layouts/v7/modules/Settings/{$MODULE}/assets/images/template.png" alt="{vtranslate('LBL_TEMPLATE_ALT', $QUALIFIED_MODULE)}" /> {vtranslate('LBL_TEMPLATE', $QUALIFIED_MODULE)}</h2>
