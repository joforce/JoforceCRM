...
Class VTPDFMaker_Edit_View extends Vtiger_Edit_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if(!empty($record)) {
			$recordModel = VTPDFMaker_Record_Model::getInstanceById($record);
		...
		$getLogoName = $adb->pquery('select logoname from vtiger_organizationdetails where organization_id = ?', array(1));
