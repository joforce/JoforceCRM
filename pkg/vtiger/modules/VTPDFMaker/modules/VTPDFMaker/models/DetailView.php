...
class VTPDFMaker_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public static function getInstance($moduleName,$recordId) {
		...
		$moduleModel = VTPDFMaker_Module_Model::getInstance($moduleName);
		$recordModel = VTPDFMaker_Record_Model::getInstanceById($recordId, $moduleName);
