	...
	function vtlib_handler($moduleName, $eventType) {
		global $adb, $site_URL;
 		if($eventType == 'module.postinstall') {
			...
			$adb->pquery("CREATE TABLE `vtiger_vtpdfmakersettings` (
                                                        `id` int(10) NOT NULL AUTO_INCREMENT,
                                                        `version` varchar(10) DEFAULT NULL,
                                                        PRIMARY KEY (`id`)
                                                                        ) ENGINE=InnoDB DEFAULT CHARSET=utf8",array());
                        $adb->pquery('insert into vtiger_vtpdfmakersettings (id, version) values (1, ?)', array('0.1'));

			include_once('vtlib/Vtiger/Module.php');
			$moduleInstance = Vtiger_Module::getInstance('VTPDFMaker');
			$moduleInstance->addLink('HEADERSCRIPT', 'HEADERSCRIPT', 'layouts/v7/modules/VTPDFMaker/resources/Helper.js');

			$adb->pquery("insert into vtiger_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(1, 'Invoice', 'Invoices', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into vtiger_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(2, 'Quotes', 'Quotes', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into vtiger_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(3, 'PurchaseOrder', 'Purchase Orders', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
			<td style="font-size:20px;width:50%;text-align:right;"><b>INVOICE</b></td>
		</tr><tr><td style="width:50%;">$company-address$</td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into vtiger_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(4, 'SalesOrder', 'Sales Orders', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
...
', 1, '', '', '##Page##'));
			$adb->pquery('insert into vtiger_vtpdfmaker_seq values(?)', array(4));
                        $getcvId = $adb->pquery('select id from vtiger_customview_seq', array());
                        $cvId = $adb->query_result($getcvId, 0, 'id');
                        $adb->pquery('insert into vtiger_customview values (?, ?, ?, ?, ?, ?, ?)', array($cvId, 'All', 1, 0, 'VTPDFMaker', 0, 1));
