...
$languageStrings = array(
	...
	'LBL_CUSTOM_VIEW_NAME_DUPLICATES_EXIST' => 'Список уже существует'       ,
        'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'Для экспорта валютных ценностей в отдельных позиций, Head будет использовать этот параметр для экспорта, как этой валюты. Любые валютные ценности за пределами таблиц позиций, будет экспортироваться как в пользователей привилегированную валюте (выбранной в Моих настройках)',
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'Head CRM On Demand'        ,
...
                                           Например, для преобразования телефонного номера США (415 599 2671) в формат E.164, нужно было бы добавить \'+\' префикс и код страны (что 1) в передней части числа (+1 415 599 2671 ). В Великобритании и многих других стран на международном уровне, местные функции требуется добавление 0 перед номером абонента. Однако, чтобы использовать форматирование E.164, это 0 должны быть удалены. Ряд таких как 020 7183 8750 в Великобритании будут отформатированы как +44 20 7183 8750.',
	...
	'vt_create' => 'Head Создано',
	'vt_update' => 'Head Обновлено',
	'vt_delete' => 'Head удаленных',
	'vt_skip' => 'Head Пропущено',
...
$jsLanguageStrings = array(
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'Валютные ценности в очереди за импортом предметов, Head будет использовать этот параметр, чтобы определить валюту. Любые валютные ценности за пределами таблиц позиций, предполагаются в разделе Пользователи предпочитают валюты (выбирается в моих предпочтениях)',
	...
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Подходит поле Head не доступны для отображения',
    ...
    'OFFICE365_REMOVE_SYNCHRONIZATION_MESSAGE' => 'Нажатие на это будет удалить существующий аутентификацию Office365. Это не будет удалять какие-либо записи, которые уже синхронизированы. Он не будет отменять регистрацию приложение Head от вас Office365 счет, отменить посетить https://myapps.microsoft.com/',
