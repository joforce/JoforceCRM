...
$languageStrings = array(
	...
	'LBL_CUSTOM_VIEW_NAME_DUPLICATES_EXIST' => 'filter already exists'       ,
        'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'For exporting Currency values in Line items, Head will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
    ...
    'LBL_TIME' => 'Time',
    'LBL_SKIPPED' => 'Skipped',
    'vt_create' => 'Head Created',
    'vt_update' => 'Head Updated',
    'vt_delete' => 'Head Deleted',
    'vt_skip' => 'Head Skipped',
  ...
  'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
                                    Head contacts and Google contacts(in selected group updated.<br>
  ...
  'LBL_SOCIAL_LINKED' => 'Your Head is now linked to',
  'LBL_ENTER_KEYWORDS_HELP' => 'Head will scan twitter and find messages with these words',
  ...
  'LBL_SHARED_TAGS_ACCESS' => 'Shared tags are accessible by all users in Head',
...
$jsLanguageStrings = array(
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, Head will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
    ...
    'OFFICE365_REMOVE_SYNCHRONIZATION_MESSAGE' => 'Clicking on this will remove existing Office365 authentication. It will not delete any records which are already synchronized. It will not unregister the Head app from you office365 account, to unregister visit https://myapps.microsoft.com/',
  ...
  'JS_REACTIVATED_SUCCESSFULLY' => 'Head Subscription reactivated successfully',
