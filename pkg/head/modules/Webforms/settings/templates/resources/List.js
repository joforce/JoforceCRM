...
Settings_Head_List_Js("Settings_Webforms_List_Js",{
    ...
    DeleteRecord : function(deleteRecordActionUrl) {
		...
		Head_Helper_Js.showConfirmationBox({'message' : message}).then(function(data) {
				...
				function(data){
					...
					thisInstance.getListViewRecords().then(function(){
						...
						Head_Helper_Js.showPnotify(data.error.message);
					}
				});
			},
			function(error, err){
