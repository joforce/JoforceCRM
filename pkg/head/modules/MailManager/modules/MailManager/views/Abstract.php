...
abstract class MailManager_Abstract_View extends Head_Index_View {
	 ...
	 */
	public function getViewer(Head_Request $request) {
	 ...
	 * @return type
	 */
	public function getOperationArg(Head_Request $request) {
