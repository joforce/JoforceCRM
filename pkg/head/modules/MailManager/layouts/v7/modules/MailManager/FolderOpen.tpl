    ...
    <div class='col-lg-12 padding0px'>
        ...
        <span class="col-lg-5 padding0px">
            <span class="fa-stack fa-sm cursorPointer mmActionIcon" id="mmMarkAsRead" data-folder="{$FOLDER->name()}" title="{vtranslate('LBL_MARK_AS_READ', $MODULE)}">
                <img src="layouts/skins/images/envelope-open.png" id="mmEnvelopeOpenIcon">
            </span>
        ...
        <div class="col-lg-10 mmSearchContainerOther">
            <div>
                ...
                <div class="col-lg-4 padding0px mmSearchDropDown">
                    <select id="searchType" style="background: #DDDDDD url('layouts/skins/images/arrowdown.png') no-repeat 95% 40%; padding-left: 9px;">
                    ...
                    <div class="col-lg-11 mmfolderMails padding0px" title="{$MAIL->subject()}">
                        ...
                        <div class="col-lg-4 padding0px">
                            ...
                            <span class="pull-right">
                                ...
                                {/if}
                                <span class='mmDateTimeValue' title="{Head_Util_Helper::formatDateTimeIntoDayString(date('Y-m-d H:i:s', strtotime($MAIL->_date)))}">{Head_Util_Helper::formatDateDiffInStrings(date('Y-m-d H:i:s', strtotime($MAIL->_date)))}</span>
                            </span>
                        </div>
