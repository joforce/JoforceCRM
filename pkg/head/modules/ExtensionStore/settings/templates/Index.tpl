            ...
            <form class="form-horizontal signUpForm">
                ...
                <div class="modal-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="emailAddress" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="firstName" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="lastName" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" name="companyName" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="password" name="password" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                    <div class="control-group">
                        <span class="control-label">
                        ...
                        <div class="controls">
                            <input type="password" name="confirmPassword" data-validation-engine="validate[required, funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            {else}
                                <input type="text" name="emailAddress" data-validation-engine="validate[required, custom[email],funcCall[Head_Base_Validator_Js.invokeValidation]]" />
                            {/if}
                        </div>
                    </div>
                    <div class="control-group">
