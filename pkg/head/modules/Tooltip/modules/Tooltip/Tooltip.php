	...
	function vtlib_handler($moduleName, $eventType) {
		...
		global $adb,$mod_strings;
 		...
 		if($eventType == 'module.postinstall') {			
			...
			$adb->query("INSERT INTO jo_settings_field (fieldid, blockid, name, iconpath, description, linkto) 
							VALUES (".$adb->getUniqueID('jo_settings_field').", ".getSettingsBlockId($blockname).", '$name', '$icon', '$description', '$links')");
 		} else if($eventType == 'module.disabled') {
		// TODO Handle actions when this module is disabled.
			$moduleInstance = Head_Module::getInstance('Tooltip');
