...
class automatic_addressbook extends rcube_plugin
{
    ...
    public function init()
    {
        ...
        $this->load_config('config/config/config.inc.php.dist');
        if (file_exists("./plugins/automatic_addressbook/config/config/config.inc.php")) {
            $this->load_config('config/config/config.inc.php');
        }
