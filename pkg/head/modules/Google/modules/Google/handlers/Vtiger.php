...
vimport('~~/modules/WSAPP/Handlers/joforceHandler.php');
vimport('~~/include/Webservices/Utils.php');
class Google_Head_Handler extends vtigerCRMHandler {
	...
	public function put($recordDetails, $user) {
		...
		foreach ($updatedRecords as $index => $record) {
			$webserviceRecordId = $record["id"];
			//While Updating Head Record, should not update these values for event
