...
class Settings_SMSNotifier_Module_Model extends Settings_Head_Module_Model {

	var $baseTable = 'jo_smsnotifier_servers';
	...
	public static function deleteRecords($recordIdsList = array()) {
		if ($recordIdsList) {
			...
			$query = 'DELETE FROM jo_smsnotifier_servers WHERE id IN (' . generateQuestionMarks($recordIdsList). ')';
