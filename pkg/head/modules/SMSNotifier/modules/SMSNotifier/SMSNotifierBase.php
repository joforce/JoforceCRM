...
class SMSNotifierBase extends CRMEntity {
	 ...
	 */
	var $customFieldTable = Array('jo_smsnotifiercf', 'smsnotifierid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('jo_crmentity', 'jo_smsnotifier', 'jo_smsnotifiercf');
	...
	var $tab_name_index = Array(
		'jo_crmentity' => 'crmid',
		'jo_smsnotifier' => 'smsnotifierid',
		'jo_smsnotifiercf'=>'smsnotifierid');
	...
	function vtlib_handler($modulename, $event_type) {
        ...
        $SMSNotifierModule  = Head_Module::getInstance('SMSNotifier');
        Head_Access::setDefaultSharing($SMSNotifierModule);
		...
		if($unregisterLinks) {
			...
			$smsnotifierModuleInstance = Head_Module::getInstance('SMSNotifier');
