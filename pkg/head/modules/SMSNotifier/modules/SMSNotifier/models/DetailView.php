...
class SMSNotifier_DetailView_Model extends Head_DetailView_Model {
	/**
	...
	public function getDetailViewLinks($linkParams) {
		...
		$linkModelList['DETAILVIEW'][] = Head_Link_Model::getInstanceFromValues(array('linklabel' => 'LBL_CHECK_STATUS'));
		...
		for ($i=0; $i<$countOfList; $i++) {
			...
			if ($linkModel->get('linklabel') == 'LBL_CHECK_STATUS') {
				...
				$linkModelList['DETAILVIEW'][$i]->set('linkurl', "javascript:Head_Detail_Js.checkSMSStatus('".$recordModel->getCheckStatusUrl()."')");
				break;
			}
		}
