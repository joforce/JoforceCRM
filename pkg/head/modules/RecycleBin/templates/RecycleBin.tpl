...
{include file='Buttons_List.tpl'}
                                <div id="searchingUI" style="display:none;">
                                        ...
                                        <tr>
                                                <td align=center>
                                                <img src="{'searching.gif'|@jo_imageurl:$THEME}" alt="{$APP.LBL_SEARCHING}"  title="{$APP.LBL_SEARCHING}">
                                                </td>
                                        </tr>
                                        </table>
...
<tr><td valign=top><img src="{'showPanelTopLeft.gif'|@jo_imageurl:$THEME}"></td>
