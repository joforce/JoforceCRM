...
require_once 'modules/WSAPP/synclib/connectors/HeadConnector.php';
...
abstract class WSAPP_SynchronizeController {
	...
	function getSourceConnector() {
		$connector =  new WSAPP_HeadConnector();
		...
		return $connector->setName('Head_'.$targetName);
	}
	...
	function getSourceRecordModel($data) {
		return new WSAPP_HeadModel($data);
	}
