...
class ProjectTask_QuickEditAjax_View extends Head_IndexAjax_View {
	...
	public function process(Head_Request $request) {
		...
		$recordStructureInstance = Head_RecordStructure_Model::getInstanceFromRecordModel($recordModel, 'GanttQuickEdit');
