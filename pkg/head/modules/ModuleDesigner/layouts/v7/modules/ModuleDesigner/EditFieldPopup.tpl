...
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/mandatory.png" alt="{vtranslate('LBL_MANDATORY_ALT', $QUALIFIED_MODULE)}" /> {vtranslate('LBL_MANDATORY', $QUALIFIED_MODULE)}</td>
	<td colspan="2"><input type="checkbox" name="mandatory" value="1" {if $a_field.mandatory}checked="checked"{/if} /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/entityidentifier.png" alt="{vtranslate("LBL_ENTITY_IDENTIFIER_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_ENTITY_IDENTIFIER", $QUALIFIED_MODULE)}</td>
...
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/filterall.png" alt="{vtranslate("LBL_FILTER_ALL_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_IN_FILTER_ALL", $QUALIFIED_MODULE)}</td>
	<td colspan="2"><input type="checkbox" name="in_filter_all" value="1" {if $a_field.inFilterAll}checked="checked"{/if} /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/popup.png" alt="{vtranslate("LBL_IN_POPUP_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_IN_POPUP", $QUALIFIED_MODULE)}</td>
...
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/related.png" alt="{vtranslate("LBL_RELATED_LIST_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_IN_RELATED_LIST", $QUALIFIED_MODULE)}</td>
...
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/create.png" alt="{vtranslate("LBL_QUICK_CREATE_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_QUICK_CREATE", $QUALIFIED_MODULE)}</td>
	<td colspan="2"><input type="checkbox" name="quick_create" value="1" {if $a_field.quickCreate}checked="checked"{/if} /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/massedit.png" alt="{vtranslate("LBL_MASS_EDIT_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_MASS_EDITABLE", $QUALIFIED_MODULE)}</td>
	<td colspan="2"><input type="checkbox" name="mass_editable" value="1" {if $a_field.massEditable}checked="checked"{/if} /></td>
</tr>
<tr>
	<td><img src="{$SITEURL}layouts/modules/Settings/{$MODULE}/assets/images/readonly.png" alt="{vtranslate("LBL_READ_ONLY_ALT", $QUALIFIED_MODULE)}" /> {vtranslate("LBL_READ_ONLY", $QUALIFIED_MODULE)}</td>
