	...
	function vtlib_handler($moduleName, $eventType) {
		global $adb, $site_URL;
 		if($eventType == 'module.postinstall') {
			...
			$adb->pquery("insert into jo_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(1, 'Invoice', 'Invoices', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into jo_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(2, 'Quotes', 'Quotes', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into jo_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(3, 'PurchaseOrder', 'Purchase Orders', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
			<td style="font-size:20px;width:50%;text-align:right;"><b>INVOICE</b></td>
		</tr><tr><td style="width:50%;">$company-address$</td>
...
', 1, '', '', '##Page##'));
			$adb->pquery("insert into jo_vtpdfmaker values(?,?,?,?,?,?,?,?,?)", array(4, 'SalesOrder', 'Sales Orders', '', '<table width="985"><tbody><tr><td style="width:50%;"><img alt="" height="79" src="'.$site_URL.'test/logo/vtiger-crm-logo.png" width="200" /></td>
			<td style="width:50%;"> </td>
		</tr><tr><td style="width:50%;">$company-organizationname$</td>
