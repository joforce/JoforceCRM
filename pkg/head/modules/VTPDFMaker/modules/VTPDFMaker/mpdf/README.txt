...
or $this->useSubstitutions = true; in the config/config.php file
...
new mPDF('..-aCJK')  new mPDF('-aCJK')
	...
	This can be used at runtime to override the value set for $mpdf->useAdobeCJK in config/config.php
