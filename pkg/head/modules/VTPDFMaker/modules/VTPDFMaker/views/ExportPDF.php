<?php
class VTPDFMaker_ExportPDF_View extends Head_BasicAjax_View {
    ...
    public function process(Head_Request $request) {
		...
		$getDetails = $adb->pquery('select * from jo_vtpdfmaker where module = ? and status = ?', array($moduleInfo[$sourceModule], 1));
