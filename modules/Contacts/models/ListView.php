	...
	public function getListViewMassActions($linkParams) {
		...
		if($currentUserModel->hasModulePermission($emailModuleModel->getId())) {
			$massActionLink = array(
				...
				'linkurl' => 'javascript:Vtiger_List_Js.triggerSendEmail("'.$site_URL.'index.php?module='.$this->getModule()->getName().'&view=MassActionAjax&mode=showComposeEmailForm&step=step1","Emails");',
				'linkicon' => ''
			);
