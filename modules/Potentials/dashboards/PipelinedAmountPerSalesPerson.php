...
class Potentials_PipelinedAmountPerSalesPerson_Dashboard extends Head_IndexAjax_View {
	...
	public function process(Head_Request $request) {
        ...
        for($i = 0;$i<count($data);$i++){
            $data[$i]["links"] = $listViewUrl.$this->getSearchParams($data[$i]["last_name"],$data[$i]["link"]).'/1';
        }
