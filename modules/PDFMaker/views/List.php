...
class PDFMaker_List_View extends Head_Index_View {
	...
	function preProcess(Head_Request $request, $display=true) {
		...
		$this->listViewModel = PDFMaker_ListView_Model::getInstance($moduleName, $cvId, $listHeaders);
	...
	public function initializeListViewContents(Head_Request $request, Head_Viewer $viewer) {
		...
		if(!$this->listViewModel) {
			$listViewModel = PDFMaker_ListView_Model::getInstance($moduleName, $cvId, $listHeaders);
		} else {
...
//		$viewer->assign('SELECTED_HEADER_FIELDS', $selectedHeaderFields);
	...
	function getListViewCount(Head_Request $request){
		...
		$listViewModel = PDFMaker_ListView_Model::getInstance($moduleName, $cvId);
