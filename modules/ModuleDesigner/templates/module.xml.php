...
<?php if($tableName == 'jo_crmentity'){continue;} ?>
<table>
...
<?php else: ?>
<table>
<name>jo_<?php echo $o_module->lowerName; ?></name>
<sql><![CDATA[CREATE TABLE `jo_<?php echo $o_module->lowerName; ?>` (
  `<?php echo $o_module->lowerName; ?>id` int(11) NOT NULL DEFAULT '0',
  <?php foreach($o_module->a_fields as $o_field): ?><?php if(empty($o_field->tableName) || $o_field->tableName == 'jo_'.$o_module->lowerName): ?>
  `<?php echo $o_field->fieldName; ?>` <?php echo $o_field->UITypeDBType; ?> DEFAULT NULL,
  <?php endif; ?><?php endforeach; ?>
  PRIMARY KEY (`<?php echo $o_module->lowerName; ?>id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8]]></sql>
...
<?php endif; ?>
<?php $cfTableName = !empty($o_module->customFieldTable) ? $o_module->customFieldTable : 'jo_'.$o_module->lowerName.'cf'; ?>
<?php  
...
<tablename><?php echo !empty($o_field->tableName) ? $o_field->tableName : 'jo_'.$o_module->lowerName; ?></tablename>
