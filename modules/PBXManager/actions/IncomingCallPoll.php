...
class PBXManager_IncomingCallPoll_Action extends Head_Action_Controller{
    ...
    public function checkModuleViewPermission(Head_Request $request){
    ...
    public function searchIncomingCalls(Head_Request $request){
   ...
   public function createRecord(Head_Request $request){
            $user = Users_Record_Model::getCurrentUserModel();
            ...
            foreach($mandatoryFieldModels as $mandatoryField){
                ...
                if(!empty($element[$fieldName])){
                    ...
                    if(empty($fieldValue)) {
                        $fieldValue = Head_Util_Helper::getDefaultMandatoryValue($fieldType);
                    }
    ...
    function checkPermissionForPolling(Head_Request $request) {
        Users_Privileges_Model::getCurrentUserPrivilegesModel();
