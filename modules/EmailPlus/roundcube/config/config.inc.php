...
//$config['curret_user'] = $_GET['current_user_id'];
// ----------------------------------
// SMTP
// ----------------------------------
...
$config['support_url'] = 'http://smackcoders.com';
...
$config['plugins'] = array('autologon', 'crmattachment', 'automatic_addressbook','sender_details');
