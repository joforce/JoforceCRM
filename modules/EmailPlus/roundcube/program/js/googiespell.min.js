...
b);c.ignoreError(a,b)});l.appendChild(n);h.appendChild(l);g.appendChild(h)}var q=0;for(f=k.length;q<f;q++)h=document.createElement("tr"),l=document.createElement("td"),n=document.createElement("span"),$(n).html(k[q]),$(l).mouseover(this.item_onmouseover).mouseout(this.item_onmouseout).click(function(d){c.correctError(b,a,d.target.firstChild)}),l.appendChild(n),h.appendChild(l),g.appendChild(h);if(a.is_changed&&a.innerHTML!=a.old_value){var r=a.old_value;k=document.createElement("tr");f=document.createElement("td");
