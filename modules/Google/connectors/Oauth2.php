...
class Google_Oauth2_Connector {
    ...
    protected $table_name = 'jo_google_oauth2';
    ...
    public function __construct($module,$userId=false) {
        ...
        $this->scope = 'https://www.googleapis.com/auth/contacts https://www.googleapis.com/auth/calendar';
    }
    ...
    protected function fireRequest($url,$headers,$params=array(),$method='POST') {
        $httpClient = new Head_Net_Client($url);
