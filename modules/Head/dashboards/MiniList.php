...
class Head_MiniList_Dashboard extends Head_IndexAjax_View {

	public function process(Head_Request $request, $widget=NULL) {
		...
		$widget = Head_Widget_Model::getInstanceWithWidgetId($widgetId, $currentUser->getId());

		$minilistWidgetModel = new Head_MiniList_Model();
