...
class Head_History_Dashboard extends Head_IndexAjax_View {
	...
	public function process(Head_Request $request) {
		...
		if(!empty($modifiedTime)) {
			$startDate = Head_Date_UIType::getDBInsertedValue($modifiedTime['start']);
			$dates['start'] = getValidDBInsertDateTimeValue($startDate . ' 00:00:00');
			$endDate = Head_Date_UIType::getDBInsertedValue($modifiedTime['end']);
