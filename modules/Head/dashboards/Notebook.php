...
class Head_Notebook_Dashboard extends Head_IndexAjax_View {
	...
	public function process(Head_Request $request, $widget=NULL) {
		...
		$widget = Head_Notebook_Model::getUserInstance($widgetId);
	...
	protected function getKeyMetricsWithCount() {
		...
		foreach ($metriclists as $key => $metriclist) {
			...
			if($metriclist['module'] == "Calendar") {
				...
				$metricresult = $adb->query(Head_Functions::mkCountQuery($metricsql));
			} else {
