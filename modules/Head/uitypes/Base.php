...
class Head_Base_UIType extends Head_Base_Model {
	...
	/**
	 * Static function to get the UIType object from Head Field Model
	 * @param Head_Field_Model $fieldModel
	 * @return Head_Base_UIType or UIType specific object instance
	 */
	public static function getInstanceFromField($fieldModel) {
		...
		$uiTypeClassName = 'Head_'.$uiTypeClassSuffix.'_UIType';
		$fallBackClassName = 'Head_Base_UIType';

		$moduleSpecificFileName = 'modules.'. $moduleName .'.uitypes.'.$uiTypeClassSuffix;
		$uiTypeClassFileName = 'modules.Head.uitypes.'.$uiTypeClassSuffix;

		$moduleSpecificFilePath = Head_Loader::resolveNameToPath($moduleSpecificFileName);
		$completeFilePath = Head_Loader::resolveNameToPath($uiTypeClassFileName);
