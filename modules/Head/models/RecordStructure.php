...
/**
 * Head Record Structure Model
 */
class Head_RecordStructure_Model extends Head_Base_Model {
	 ...
	 * @param <Head_Record_Model> $recordModel - record instance
	 * @return Head_RecordStructure_Model
	 */
	public static function getInstanceFromRecordModel($recordModel, $mode=self::RECORD_STRUCTURE_MODE_DEFAULT) {
		$moduleModel = $recordModel->getModule();
		$className = Head_Loader::getComponentClassName('Model', $mode.'RecordStructure', $moduleModel->getName(true));
	 ...
	 * @param <Head_Module_Model> $moduleModel - module instance
	 * @return Head_RecordStructure_Model
	 */
	public static function getInstanceForModule($moduleModel, $mode=self::RECORD_STRUCTURE_MODE_DEFAULT) {
		$className = Head_Loader::getComponentClassName('Model', $mode.'RecordStructure', $moduleModel->get('name'));
		$instance = new $className();
