 ...
 */
class Head_CssScript_Model extends Head_Base_Model {
	...
	/**
	 * Function to get the instance of CSS Script model from a given Head_Link object
	 * @param Head_Link $linkObj
	 * @return Head_CssScript_Model instance
	 */
