...
/**
 * Head Summary View Record Structure Model
 */
class Head_SummaryRecordStructure_Model extends Head_DetailRecordStructure_Model {
	...
	public function getStructure() {
		...
		if(empty($summaryFieldsList)) {
			...
			if($fieldModuleModel->getName() == 'Events') {
				$fieldModuleModel = Head_Module_Model::getInstance('Calendar');
			}
