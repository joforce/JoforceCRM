...
class Head_IndexAjax_View extends Head_Index_View {
	 ...
	 */
	function showActiveRecords(Head_Request $request) {
	...
	function getRecordsListFromRequest(Head_Request $request) {
