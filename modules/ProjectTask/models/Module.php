...
class ProjectTask_Module_Model extends Head_Module_Model {
	...
	public function getProjectsListUrl() {
		$taskModel = Head_Module_Model::getInstance('Project');
	...
	public function getConfigureRelatedListFields(){
		...
		if(!$relatedListFields['projecttaskstatus']) {
			$fieldModel = Head_Field_Model::getInstance('projecttaskstatus', $this);
			if($fieldModel && $fieldModel->isViewableInDetailView()) {
				$relatedListFields['projecttaskstatus'] = 'projecttaskstatus';
			}
		}
		if(!$relatedListFields['projecttaskprogress']) {
			$fieldModel = Head_Field_Model::getInstance('projecttaskprogress', $this);
			if($fieldModel && $fieldModel->isViewableInDetailView()) {
