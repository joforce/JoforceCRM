...
class Settings_Vtiger_OutgoingServer_Model extends Settings_Vtiger_Systems_Model {
	...
	public function getEditViewUrl() {
		...
		return vglobal('site_URL').'Settings/Vtiger/OutgoingServerEdit/'.$menuItem->get('blockid').'/'.$menuItem->get('fieldid');
	}
	
	public function getDetailViewUrl() {
		$menuItem = $this->getMenuItem();
		return vglobal('site_URL').'Vtiger/Settings/OutgoingServerDetail/'.$menuItem->get('blockid').'/'.$menuItem->get('fieldid');
	}
