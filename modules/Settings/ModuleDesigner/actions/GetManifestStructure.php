...
class Settings_ModuleDesigner_GetManifestStructure_Action extends Settings_Head_Index_Action
{
	...
	protected function getManifestFilePath($moduleNameOrPackageFilePath, $isPackage=false)
	{
		...
		{
			$unzip = new Head_Unzip($moduleNameOrPackageFilePath, true);
	...
	{
		$o_module->defaultTable = "jo_".strtolower($moduleName);
