...
class Settings_ModuleDesigner_Index_View extends Settings_Head_Index_View {
	...
	public function process(Head_Request $request)
	{
		...
		//Get parent tabs
		$query = "SELECT * FROM jo_parenttab ORDER BY parenttab_label ASC";
		...
		//Get modules
		$query = "SELECT * FROM jo_tab ORDER BY tablabel ASC";
		$result = $db->pquery($query, array());
	...
	public function getHeaderCss(Head_Request $request) {
		...
		$cssFileNames = array(
			'~/layouts/modules/Settings/'.$moduleName.'/assets/styles.css',
			'~/layouts/modules/Settings/'.$moduleName.'/assets/jqueryFancybox.css'
		);
