...
class Settings_DuplicateCheck_List_View extends Settings_Head_Index_View {
	...
	$queryVTDup = $adb->pquery("SELECT isenabled,crosscheck FROM jo_duplicatechecksettings WHERE modulename='$sourceModule'");
