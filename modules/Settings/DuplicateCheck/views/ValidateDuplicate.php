...
class Settings_DuplicateCheck_ValidateDuplicate_View extends Settings_Head_Index_View
{
	public function process(Head_Request $request)
	{
		...
		if(($crossmodulename == 'Leads') && ($crosstablename == 'jo_leadscf'))
                        $crosscheckvalQuery .=" inner join $crosstablename on $crosstablename.$crossentityid = jo_crmentity.crmid ";
		else if(($crossmodulename == 'Leads') && ($crosstablename != $crossnametable))
			$crosscheckvalQuery .=" inner join $crosstablename on $crosstablename.leadaddressid = jo_crmentity.crmid "
;
		if(($crossmodulename == 'Contacts') && ($crosstablename == 'jo_contactscf'))
                        $crosscheckvalQuery .=" inner join $crosstablename on $crosstablename.$crossentityid = jo_crmentity.crmid ";
		else if(($crossmodulename == 'Contacts') && ($crosstablename != $crossnametable))  
                        $crosscheckvalQuery .=" inner join $crosstablename on $crosstablename.contactsubscriptionid = jo_crmentity.crmid ";
		if(($crossmodulename == 'Accounts') && ($crosstablename != $crossnametable))
                        $crosscheckvalQuery .=" inner join $crosstablename on $crosstablename.$crossentityid = jo_crmentity.crmid ";
