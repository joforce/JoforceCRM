...
class Settings_Head_Systems_Model extends Head_Base_Model{

    const tableName = 'jo_systems';
    ...
    public static function getInstanceFromServerType($type,$componentName) {
        ...
        try{
        $modelClassName = Head_Loader::getComponentClassName('Model', $componentName, 'Settings:Head');
        }catch(Exception $e) {
            $modelClassName = self;
        }
