...
class Settings_Head_TaxRecord_Model extends Head_Base_Model{
	...
	public function getCreateTaxUrl() {
		return '?module=Head&parent=Settings&view=TaxAjax';
	}
	
	public function getEditTaxUrl() {
		return '?module=Head&parent=Settings&view=TaxAjax&type='.$this->getType().'&taxid='.$this->getId();
	}
