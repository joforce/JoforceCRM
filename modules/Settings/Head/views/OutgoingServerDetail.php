...
class Settings_Head_OutgoingServerDetail_View extends Settings_Head_Index_View {
    ...
    public function process(Head_Request $request) {
		...
		$viewer->assign('OD_DEFAULT_MAIL_SERVER_IP', HeadConfig::getOD('OD_DEFAULT_MAIL_SERVER_IP'));
