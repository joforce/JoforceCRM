...
class Settings_Head_TaxAjax_View extends Settings_Head_Index_View {
	...
	public function editTax(Head_Request $request) {
	...
	public function editTaxRegion(Head_Request $request) {
		$viewer = $this->getViewer ($request);
		$moduleName = $request->getModule();
		$qualifiedModuleName = $request->getModule(false);
	...
	public function editCharge(Head_Request $request) {
		$viewer = $this->getViewer ($request);
		$moduleName = $request->getModule();
		$qualifiedModuleName = $request->getModule(false);
