...
class Settings_Head_TermsAndConditionsEdit_View extends Settings_Head_Index_View {
    
    public function process(Head_Request $request) {
		$inventoryModules = getInventoryModules();
        $model = Settings_Head_TermsAndConditions_Model::getInstance($inventoryModules[0]);
