...
class Settings_Head_Extension_View extends Settings_Head_Index_View {
	 ...
	 */
	function getExtensionViewInstance(Head_Request $request) {
		$extensionModule = $request->get('extensionModule');
		$extensionView = $request->get('extensionView');
		$extensionViewClass = Head_Loader::getComponentClassName('view', $extensionView, $extensionModule);
	...
	static function getExtensionLinks($module) {
		...
		$links = Head_Link_Model::getAllByType(getTabid($module), array('EXTENSIONLINK'), $linkParams);
	...
	function getHeaderScripts(Head_Request $request) {
		...
		$jsFileNames = array(
			'modules.Head.resources.Extension',
			'modules.Head.resources.ExtensionCommon',
