...
class Settings_Head_CustomRecordNumbering_View extends Settings_Head_Index_View {

	public function process(Head_Request $request) {
		$qualifiedModuleName = $request->getModule(false);
		$supportedModules = Settings_Head_CustomRecordNumberingModule_Model::getSupportedModules();
	...
	function getHeaderScripts(Head_Request $request) {
		...
		$jsFileNames = array(
			"modules.Settings.Head.resources.CustomRecordNumbering"
		);
