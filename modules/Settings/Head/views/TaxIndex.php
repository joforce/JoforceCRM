...
class Settings_Head_TaxIndex_View extends Settings_Head_Index_View {
	...
	public function showChargesAndItsTaxes(Head_Request $request) {
		$qualifiedModuleName = $request->getModule(false);
		$taxRecordModel = new Inventory_TaxRecord_Model();
	...
	public function showTaxRegions(Head_Request $request) {
		$qualifiedModuleName = $request->getModule(false);
