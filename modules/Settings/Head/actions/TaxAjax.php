...
class Settings_Head_TaxAjax_Action extends Settings_Head_Basic_Action {
	...
	public function saveTax(Head_Request $request) {
	...
	public function updateTaxStatus(Head_Request $request) {
		$taxId = $request->get('taxid');
		$type = $request->get('type');
	...
	public function saveTaxRegion(Head_Request $request) {
	...
	public function deleteTaxRegion(Head_Request $request) {
		$taxRegionId = $request->get('taxRegionId');
		$response = new Head_Response();
		if ($taxRegionId) {
			try {
	...
	public function saveCharge(Head_Request $request) {
	...
	public function deleteCharge(Head_Request $request) {
		$chargeId = $request->get('chargeId');
		$response = new Head_Response();
		if ($chargeId) {
			try {
	...
	public function checkDuplicateTaxName(Head_Request $request) {
	...
	public function checkDuplicateInventoryCharge(Head_Request $request) {
	...
	public function checkDuplicateTaxRegion(Head_Request $request) {
