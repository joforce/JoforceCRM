 ...
 */
class Settings_Webhooks_Module_Model extends Head_Module_Model {

	var $baseTable = 'jo_webhooks';
	var $baseIndex = 'id';
        var $listFields = array('name'=>'Webhook Name', 'targetmodule' => 'Module', 'url' => 'Endpoint URL', 'enabled' => 'Status', 'events' => 'Events');
	...
	var $name = 'Webhooks';
        ...
        public static function getEvents() {
                $webhooksEvents = array('created' => 'Created', 'updated' => 'Updated', 'deleted' => 'Deleted');
	...
	public function getName($includeParentIfExists = false) {
        ...
        public function deleteRecord($recordModel) {
                ...
                $db->pquery("DELETE from jo_webhooks WHERE id = ?", array($recordId));
                return true;
        }
        ...
        global $site_URL;
                return $site_URL.$this->getName()."/".$this->getParentName()."/Edit";
        }
        ...
        global $site_URL;
                return $site_URL.$this->getName()."/".$this->getParentName()."/List";
        }
	...
	public function setListFields($fieldNames) {
         ...
         * @return <Array> list of Block models <Settings_Webhooks_Block_Model>
         */
        public function getBlocks() {
                if(empty($this->blocks)) {
                        $this->blocks =  Settings_Webhooks_Block_Model::getAllForModule($this);
                }
                return $this->blocks;
        }
