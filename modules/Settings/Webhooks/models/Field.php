...
class Settings_Webhooks_Field_Model extends Head_Field_Model {
	...
	public function getPicklistValues() {
		if ($this->getName() === 'targetmodule') {
			return Settings_Webhooks_Module_Model::getSupportedModulesList();
		}
		if($this->getName() == 'events'){
			return Settings_Webhooks_Module_Model::getEvents(); 
		}
		if($this->getName() == 'fields'){
			return Settings_Webhooks_Record_Model::getAllFieldsList('Potentials');
		}	
		return array();
	}
