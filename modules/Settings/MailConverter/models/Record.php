...
class Settings_MailConverter_Record_Model extends Settings_Head_Record_Model {
	...
	public function getDefaultUrl() {
		...
		return vglobal('site_URL'). $moduleModel->getName() . '/' . $moduleModel->getParentName() . '/' . $this->getId();
	}
	...
	public function getScanUrl() {
        $moduleModel = $this->getModule();
		$url = 'index.php?module=' . $moduleModel->getName() . '&parent=' . $moduleModel->getParentName() . '&record=' . $this->getId(). '&action=ScanNow';
	...
	public function getDeleteUrl() {
        $moduleModel = $this->getModule();
		return 'index.php?module=' . $moduleModel->getName() . '&parent=' . $moduleModel->getParentName() . '&record=' . $this->getId(). '&action=DeleteMailBox';
	}
