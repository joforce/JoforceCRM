...
class Invoice_Detail_View extends Inventory_Detail_View {
	...
	function process(Head_Request $request) {
		...
		$this->invoice_no =$this->focusColumnValue('invoice_no', false);
		$this->notes =$this->focusColumnValue('description', false);
		$this->invoicedate =$this->focusColumnValue('invoicedate', false);
		...
		$viewer->assign('INVOICE_DATE', $this->invoicedate);
		$viewer->assign('INVOICE_NO', $this->invoice_no);
