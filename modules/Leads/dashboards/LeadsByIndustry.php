...
class Leads_LeadsByIndustry_Dashboard extends Head_IndexAjax_View {
	...
	public function process(Head_Request $request) {
        ...
        for($i = 0;$i<count($data);$i++){
            $data[$i]["links"] = $listViewUrl.$this->getSearchParams($data[$i][2],$request->get('smownerid'), $request->get('dateFilter')).'/1';
        }
