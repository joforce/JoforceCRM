...
protected $module;
	...
	function process(Head_Request $request) {
		...
		$this->quotestage =$this->focusColumnValue('quotestage', false);
		$this->quote_no =$this->focusColumnValue('quote_no', false);
		$this->notes =$this->focusColumnValue('description', false);
		$this->validtill =$this->focusColumnValue('validtill', false);
		...
		$viewer->assign('QUOTESTAGE', $this->quotestage);
		$viewer->assign('VALIDTILL', $this->validtill);
		$viewer->assign('QUOTE_NO', $this->quote_no);
