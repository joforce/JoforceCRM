...
class Project_DetailView_Model extends Head_DetailView_Model {
	...
	public function getWidgets() {
		...
		$helpDeskInstance = Head_Module_Model::getInstance('HelpDesk');
	...
	public function getDetailViewRelatedLinks() {
		...
		$relatedLinks[] = array(
			...
			'linkicon' => $site_URL.'/layouts/skins/images/summary_chart.png',
			);
