...
#			'Faq' => 'FAQ',
	...
	function addEntriesForSettings() {
		...
		$links = array(
			...
			'Settings/Vtiger/CompanyDetails',
			'Settings/Vtiger/OutgoingServerDetail',
			'Settings/Currency/List',
			'Vtiger/Settings/TaxIndex',
			'Settings/Server/ProxyConfig',
			'Settings/Vtiger/AnnouncementEdit',
			'Settings/DefModuleView/Settings',
			'Settings/Vtiger/TermsAndConditionsEdit',
			'Vtiger/Settings/CustomRecordNumbering',
			'Settings/MailConverter/List',
			'Workflows/Settings/List',
			'Vtiger/Settings/ConfigEditorDetail',
