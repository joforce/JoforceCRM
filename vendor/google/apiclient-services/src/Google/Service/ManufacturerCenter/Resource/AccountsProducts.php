...
class Google_Service_ManufacturerCenter_Resource_AccountsProducts extends Google_Service_Resource
{
   ...
   * available.
   *
   * Uploaded products first need to be processed before they can be retrieved.
   * Until then, new products will be unavailable, and retrieval of uploaded
   ...
   * @return Google_Service_ManufacturerCenter_ManufacturersEmpty
   */
  public function uploadProduct($parent, $name, Google_Service_ManufacturerCenter_Attributes $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('uploadProduct', array($params), "Google_Service_ManufacturerCenter_ManufacturersEmpty");
  }
}
