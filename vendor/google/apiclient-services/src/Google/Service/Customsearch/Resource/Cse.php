...
class Google_Service_Customsearch_Resource_Cse extends Google_Service_Resource
{
   ...
   * transparent-background or color images: mono, gray, trans, and color.
   ...
   * black and brown.
   * @opt_param string safe Search safety level (active, off) (high, medium are
   * same as active)
   * @opt_param string siteSearchFilter Controls whether to include (i) or exclude
   * (e) results from the site named in the siteSearch parameter
   ...
   * @opt_param string hq Appends the extra hidden query terms to the query.
   ...
   * clipart, face, lineart, stock, photo, and animated.
   * @opt_param string c2coff Turns off the translation between zh-CN and zh-TW.
   * @opt_param string filter Controls turning on (1) or off (0) the duplicate
   * content filter.
   ...
   * https://wiki.creativecommons.org/wiki/CC_Search_integration for typical
   * combinations.
