 ...
 * @package vtlib
 */
class Head_LayoutExport extends Head_Package {
    const TABLENAME = 'jo_layout';
    ...
    function __initExport($layoutName) {
            ...
            Head_Utils::checkFileAccessForInclusion("layouts/$layoutName/skins/head/style.less");
    ...
    function export_Layout($layoutName) {
            ...
            $sqlresult = $adb->pquery("SELECT * FROM jo_layout WHERE name = ?", array($layoutName));
