...
class Head_PDF_Generator {
	...
	function __construct() {
		$this->pdf = new Head_PDF_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
	...
	function createLastPage() {
		...
		if ($totalHeightFooter) {
			$this->footerFrame = new Head_PDF_Frame();
	...
	function createPage($isLastPage = false) {
		...
		if ($totalHeightHeader) {
			$this->headerFrame = new Head_PDF_Frame();
		...
		// ContentViewer
		$this->contentFrame = new Head_PDF_Frame();
