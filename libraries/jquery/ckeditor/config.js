...
CKEDITOR.editorConfig = function( config ) {
    ...
    //vtiger editor toolbar configuration 
			...
			config.filebrowserBrowseUrl = jQuery('#joforce_site_url').val()+'libraries/kcfinder/browse.php?type=images'; 
			config.filebrowserUploadUrl = jQuery('#joforce_site_url').val()+'libraries/kcfinder/upload.php?type=images'; 
