 ...
 *************************************************************************************/
require_once('libraries/modlib/thirdparty/parser/feed/simplepie.inc');

/**
 * Extends SimplePie (feed parser library for Rss, Atom, etc)
 * @package modlib
 */
class Head_Feed_Parser extends SimplePie {
	var $vt_cachelocation = 'cache/libraries/modlib/feedcache';
