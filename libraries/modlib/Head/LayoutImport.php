 ...
 ************************************************************************************/
include_once('libraries/modlib/Head/LayoutExport.php');

/**
 * Provides API to import layout into vtiger CRM
 * @package modlib
 */
class Head_LayoutImport extends Head_LayoutExport {
		...
		foreach($filelist as $filename=>$fileinfo) {
			if(!$unzip->isdir($filename)) {
				...
				if($dounzip) {
                    ...
                    $fileValidation = Head_Functions::verifyClaimedMIME($filepath, $badFileExtensions);
